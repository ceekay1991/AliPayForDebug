...
@protocol APMSimplePingDelegate;

@interface APMSimplePing : NSObject
{
    _Bool _nextSequenceNumberHasWrapped;
    unsigned short _identifier;
    unsigned short _nextSequenceNumber;
    NSString *_hostName;
    id <APMSimplePingDelegate> _delegate;
...
@property(nonatomic) __weak id <APMSimplePingDelegate> delegate; // @synthesize delegate=_delegate;
