...
@interface AvailableShopInfoPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasShopStatus; // @dynamic hasShopStatus;
...
@property(retain, nonatomic) NSString *shopStatus; // @dynamic shopStatus;
