...
@protocol SickMessageCardButtomViewDelegate;

@interface SickMessageCardButtomView : UIView
{
    id <SickMessageCardButtomViewDelegate> _delegate;
...
+ (struct CGSize)buttomViewItemSizeWithData:(id)arg1;
...
@property(nonatomic) __weak id <SickMessageCardButtomViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)layout;
- (void)refreshWithDataSource:(id)arg1 withBizType:(id)arg2;
