...
- (void)updateResultSize:(struct CGSize)arg1;
- (void)updateResultOrigin:(struct CGPoint)arg1;
- (void)dealloc;
- (id)init;
...
@property(nonatomic) unsigned int itemsPerLine;
...
@property(nonatomic) __weak VZFNode *fNode;
