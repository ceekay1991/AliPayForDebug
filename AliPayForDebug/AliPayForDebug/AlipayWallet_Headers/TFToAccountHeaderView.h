...
@class TFTransferToAccount, TFVipLevelIcon, UIButton, UIImageView, UILabel;
...
@interface TFToAccountHeaderView : UIView
{
    ...
    TFVipLevelIcon *_vipLevelIcon;
}

+ (id)accountHeaderViewWithRecevierInfo:(id)arg1 delegate:(id)arg2;
@property(retain, nonatomic) TFVipLevelIcon *vipLevelIcon; // @synthesize vipLevelIcon=_vipLevelIcon;
