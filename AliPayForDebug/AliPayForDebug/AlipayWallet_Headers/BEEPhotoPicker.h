...
@property(nonatomic) unsigned long long videoCompressLevel; // @synthesize videoCompressLevel=_videoCompressLevel;
...
@property(nonatomic) unsigned long long maximumGifSize; // @synthesize maximumGifSize=_maximumGifSize;
@property(nonatomic) _Bool enablePickGifMix; // @synthesize enablePickGifMix=_enablePickGifMix;
...
- (void).cxx_destruct;
- (void)fetchAssetsWithPHAssetMediaType:(long long)arg1 Options:(id)arg2 completionBlock:(CDUnknownBlockType)arg3;
...
- (void)showPhotoPickerFromRect:(struct CGRect)arg1 inViewController:(id)arg2 withScene:(unsigned long long)arg3 manuDismiss:(_Bool)arg4 delegate:(id)arg5;
...
- (void)dealloc;
- (id)init;
- (void)compressVideoWithAsset:(id)arg1 request:(id)arg2 inPicker:(id)arg3;
