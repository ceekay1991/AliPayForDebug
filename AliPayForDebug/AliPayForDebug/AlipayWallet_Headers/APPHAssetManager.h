...
- (_Bool)shouldUseImageInterface:(id)arg1 needCompress:(_Bool)arg2 gifOption:(unsigned long long)arg3;
...
- (id)syncGetDataByLocalID:(id)arg1 imageVision:(long long)arg2 status:(CDUnknownBlockType)arg3 progress:(CDUnknownBlockType)arg4;
