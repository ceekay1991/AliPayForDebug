...
#import "XRTCI420Buffer-Protocol.h"

@class NSString;

@interface XRTCI420Buffer : NSObject <XRTCI420Buffer>
{
    scoped_refptr_0f5e2d94 _i420Buffer;
}

- (id).cxx_construct;
- (void).cxx_destruct;
- (scoped_refptr_0f5e2d94)nativeI420Buffer;
- (id)toI420;
...
- (id)initWithFrameBuffer:(scoped_refptr_0f5e2d94)arg1;
