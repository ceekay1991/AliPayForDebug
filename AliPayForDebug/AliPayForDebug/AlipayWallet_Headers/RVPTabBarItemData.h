...
@interface RVPTabBarItemData : NSObject
{
    _Bool _isSelected;
    float _selectedScale;
    float _unselectedScale;
    float _waitRender;
    float _transDuration;
    NSString *_url;
...
@property(nonatomic) float transDuration; // @synthesize transDuration=_transDuration;
@property(nonatomic) float waitRender; // @synthesize waitRender=_waitRender;
...
- (void).cxx_destruct;
@property(nonatomic) float selectedScale; // @synthesize selectedScale=_selectedScale;
@property(nonatomic) float unselectedScale; // @synthesize unselectedScale=_unselectedScale;
