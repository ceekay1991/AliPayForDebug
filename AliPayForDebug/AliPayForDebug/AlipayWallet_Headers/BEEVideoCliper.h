...
@class AVAsset, AVPlayer, BEEVideoPlayerView, BEEVideoTrimmerView, NSString, UIButton, UILabel;
...
@property(retain, nonatomic) UILabel *timmerLabel; // @synthesize timmerLabel=_timmerLabel;
