...
@class NSArray, NSMutableArray, XRTCConfiguration, XRTCPeerConnectionFactory, XRTCSessionDescription;
@protocol XRTCPeerConnectionDelegate;

@interface XRTCPeerConnection : NSObject
{
    XRTCPeerConnectionFactory *_factory;
    NSMutableArray *_localStreams;
    struct unique_ptr<xwebrtc::PeerConnectionDelegateAdapter, std::__1::default_delete<xwebrtc::PeerConnectionDelegateAdapter>> _observer;
    scoped_refptr_cd0bba88 _peerConnection;
    unique_ptr_02e3266d _nativeConstraints;
    _Bool _hasStartedRtcEventLog;
    id <XRTCPeerConnectionDelegate> _delegate;
}
...
@property(nonatomic) __weak id <XRTCPeerConnectionDelegate> delegate; // @synthesize delegate=_delegate;
- (id).cxx_construct;
- (void).cxx_destruct;
@property(readonly, nonatomic) scoped_refptr_cd0bba88 nativePeerConnection;
...
- (void)setBitrateAllocationStrategy:(unique_ptr_ccaf4088)arg1;
...
- (void)close;
@property(readonly, copy, nonatomic) XRTCConfiguration *configuration;
...
@property(readonly, nonatomic) XRTCSessionDescription *remoteDescription;
@property(readonly, nonatomic) XRTCSessionDescription *localDescription;
