...
@protocol PSDWebViewURLProtocolDelegate;

@interface PSDWebViewURLProtocol : NSURLProtocol <NSURLSessionDataDelegate, NSURLSessionTaskDelegate, NSURLConnectionDataDelegate, PSDWebViewURLProtocolDelegate>
{
