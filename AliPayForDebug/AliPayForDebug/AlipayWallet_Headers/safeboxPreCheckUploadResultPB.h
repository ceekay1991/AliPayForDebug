...
@interface safeboxPreCheckUploadResultPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSString *encryptFileKeysJson; // @dynamic encryptFileKeysJson;
@property(readonly) _Bool hasEncryptFileKeysJson; // @dynamic hasEncryptFileKeysJson;
