...
@interface BeeImageEditorAppDelegate : NSObject <DTMicroApplicationDelegate>
{
    UIViewController *_rootController;
    id _editLauncher;
}

@property(retain, nonatomic) id editLauncher; // @synthesize editLauncher=_editLauncher;
@property(retain, nonatomic) UIViewController *rootController; // @synthesize rootController=_rootController;
- (void).cxx_destruct;
- (void)dispatchApplication:(id)arg1 withOptions:(id)arg2;
