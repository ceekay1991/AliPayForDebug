...
- (void).cxx_destruct;
- (_Bool)isFromInternationalSite;
- (void)setupMultInstanceMandatoryFlag:(_Bool)arg1;
- (void)setupMultInstanceFlag:(_Bool)arg1;
- (void)setupUninterruptFlag:(_Bool)arg1;
- (_Bool)isFromCashierRecommend;
- (_Bool)isFromCashier;
