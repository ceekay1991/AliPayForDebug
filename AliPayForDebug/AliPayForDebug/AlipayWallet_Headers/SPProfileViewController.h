...
@class APContactInfo, APGroupInfo, APNewFindContactMsg, APShareServiceCardControl, ASPhotoPickerController, AUActionSheet, AULoadingIndicatorView, BEEPopMenuView, CPopMenuManager, CSPublishFeed, DTRpcAsyncCaller, GetUserHomeFeedListPBResp, NSArray, NSDate, NSDictionary, NSException, NSMutableArray, NSMutableDictionary, NSNumber, NSString, SCBigHeadView, SCBubbleView, SPBasicInfoRowsModel, SPProfileInfo, SPProfileNavbarView, SPProfileSettingDataManager, SPProfileTransmit, UIButton, UIControl, UIImageView, UILabel, UIView;
@protocol APSocialPreviewingProtocol;

@interface SPProfileViewController : SPProfileCardViewController <SPICardContainer, SCProfileSettingControllerDelegate, UIActionSheetDelegate, BEEMultiStyleCellDelegate, CPopMenuManagerDelegate, APSocialPreviewedProtocol>
{
    _Bool _showNavBarView;
    _Bool _hasMoreFeeds;
    _Bool _hadAddOther;
    ...
    _Bool _needUpdateSendActivityRetryUI;
    ...
    UIControl *_stageEntryBubble;
}

@property(retain, nonatomic) UIControl *stageEntryBubble; // @synthesize stageEntryBubble=_stageEntryBubble;
@property(nonatomic) _Bool flag_viewWillDisappear; // @synthesize flag_viewWillDisappear=_flag_viewWillDisappear;
...
@property(retain, nonatomic) UIButton *moreBarBtn; // @synthesize moreBarBtn=_moreBarBtn;
...
@property(retain, nonatomic) SPProfileNavbarView *navBarView; // @synthesize navBarView=_navBarView;
...
@property(nonatomic) _Bool needUpdateSendActivityRetryUI; // @synthesize needUpdateSendActivityRetryUI=_needUpdateSendActivityRetryUI;
...
@property(nonatomic) _Bool showNavBarView; // @synthesize showNavBarView=_showNavBarView;
...
- (id)makeLogOffErrorViewWithBtn:(_Bool)arg1;
...
- (void)onStageEntryBubbleTapped:(id)arg1;
- (void)onStageEntryIconTapped:(id)arg1;
- (void)setupEventHandler;
- (void)onGroupInfoNotify:(id)arg1;
- (void)onContactNotify:(id)arg1;
- (void)onHandleCustomPrivateSendMsg:(id)arg1;
...
- (void)dealRPCSuccess:(id)arg1;
- (void)refreshSendingWithClientCardId:(id)arg1;
- (void)checkRetryStateAndUpdateUI;
- (_Bool)checkRetryState;
- (void)sendingStatusChanged:(id)arg1;
- (void)deleteCardsWithClientIds:(id)arg1;
- (void)failedActivityCountChanged:(id)arg1;
- (void)sendActivityClean:(id)arg1;
- (void)sendActivityRetry:(id)arg1;
...
- (void)updateSendActivityRetryCard;
