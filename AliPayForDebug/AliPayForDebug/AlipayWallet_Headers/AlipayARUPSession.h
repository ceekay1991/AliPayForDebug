...
#import "AlipayARUPFrameDecoderDelegate-Protocol.h"

@class AlipayARUPFrameDecoder, NSMutableData, NSString;

@interface AlipayARUPSession : NSObject <ARUPConnectionGroupDelegate, AlipayARUPFrameDecoderDelegate>
{
    NSMutableData *_inputBuffer;
    unsigned long long _bufferReadIndex;
    unsigned long long _bufferWriteIndex;
    AlipayARUPFrameDecoder *_frameDecoder;
    id _delegate;
}
...
- (void).cxx_destruct;
- (void)dealloc;
- (void)frameDecoder:(id)arg1 statusCoder:(id)arg2 headers:(id)arg3 body:(id)arg4;
