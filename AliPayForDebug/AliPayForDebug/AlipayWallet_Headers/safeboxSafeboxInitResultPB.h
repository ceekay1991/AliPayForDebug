...
@interface safeboxSafeboxInitResultPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasMaxSize; // @dynamic hasMaxSize;
...
@property(readonly) _Bool hasUseSize; // @dynamic hasUseSize;
@property(nonatomic) int maxSize; // @dynamic maxSize;
...
@property(nonatomic) int useSize; // @dynamic useSize;
