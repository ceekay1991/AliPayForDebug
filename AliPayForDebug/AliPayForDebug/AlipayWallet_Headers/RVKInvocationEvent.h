...
@class NSDictionary, NSString, RVKInvocation, RVKJsApi;
...
@property(retain, nonatomic) RVKInvocation *invocation; // @synthesize invocation=_invocation;
...
@property(readonly, nonatomic) RVKJsApi *jsApi; // @synthesize jsApi=_jsApi;
