...
@class DFMicroApplicationFactory, DFStartApplicationOperation, DTMicroApplication, NSMutableArray, NSMutableSet;
...
@interface DFMicroApplicationManager : NSObject
{
    ...
    _Bool _isUpdateSceneParams;
    _Bool _enqueueAppWithNoSleepClose;
...
@property _Bool enqueueAppWithNoSleepClose; // @synthesize enqueueAppWithNoSleepClose=_enqueueAppWithNoSleepClose;
@property(nonatomic) _Bool isUpdateSceneParams; // @synthesize isUpdateSceneParams=_isUpdateSceneParams;
...
- (id)appStackContexts;
- (id)handleAppSceneParams:(id)arg1 sceneParams:(id)arg2;
...
- (id)findOriViewControllersForNavigation:(id)arg1;
...
- (void)syncExitAllApplication;
- (void)exitLauncherApplication;
...
- (_Bool)syncStartApplication:(id)arg1 params:(id)arg2 launchMode:(long long)arg3;
- (_Bool)restartLauncherApplication:(id)arg1;
- (_Bool)startLauncherApplication;
- (id)applicationForName:(id)arg1 params:(id)arg2 sceneParams:(id)arg3 createIfNotExits:(_Bool)arg4 isStartApp:(_Bool)arg5;
- (_Bool)checkExistWillExitApplication;
- (id)applicationExistInDelayRelease:(id)arg1;
- (id)createApplicationForName:(id)arg1 params:(id)arg2 sceneParams:(id)arg3;
