...
@class NSString, UcdpPageBodyPB;

@interface UcdpCreativeDeliverResultPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) UcdpPageBodyPB *result; // @dynamic result;
