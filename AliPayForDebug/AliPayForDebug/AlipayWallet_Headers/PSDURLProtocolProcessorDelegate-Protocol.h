...
@class NSData, NSError, NSString, NSURLProtocol, NSURLRequest, NSURLResponse, PSDURLProtocolProcessor;

@protocol PSDURLProtocolProcessorDelegate <NSObject>
- (void)PSDURLProtocolProcessor:(PSDURLProtocolProcessor *)arg1 didCancel:(NSError *)arg2 protocol:(NSURLProtocol *)arg3;
- (void)PSDURLProtocolProcessor:(PSDURLProtocolProcessor *)arg1 didFailWithError:(NSError *)arg2 protocol:(NSURLProtocol *)arg3;
- (void)PSDURLProtocolProcessor:(PSDURLProtocolProcessor *)arg1 didFinishLoading:(NSData *)arg2 receiveDataLength:(unsigned long long)arg3 protocol:(NSURLProtocol *)arg4;
