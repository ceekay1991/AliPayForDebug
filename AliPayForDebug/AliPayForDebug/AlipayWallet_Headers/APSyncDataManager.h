...
#import "MAErrorInterface-Protocol.h"

@class NSString;
@protocol APSyncDataManagerDelegate;
...
+ (void)receiveBizName:(id)arg1 bizCount:(unsigned long long)arg2;
+ (id)syncDataManager:(id)arg1;
+ (void)apmonitor_receiveBizName:(id)arg1 bizCount:(unsigned long long)arg2;
+ (_Bool)isEnableAMNetMonitor;
+ (void)doMTLoadWork;
@property(nonatomic) __weak id <APSyncDataManagerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)sendStWith3001DataExt:(id)arg1 userId:(id)arg2 seesionId:(id)arg3;
...
- (void)flowStatisticUpFlow:(long long)arg1 downFow:(long long)arg2;
