...
@class MFSelectionGrabber, NSArray, NSMutableArray, NSTimer, UIColor;

@interface MFTextSelectionView : UIView
{
    _Bool _caretBlinks;
    _Bool _caretVisible;
    _Bool _verticalForm;
    ...
    UIView *_caretView;
    MFSelectionGrabber *_startGrabber;
    MFSelectionGrabber *_endGrabber;
    NSTimer *_caretTimer;
...
@property(retain, nonatomic) MFSelectionGrabber *endGrabber; // @synthesize endGrabber=_endGrabber;
@property(retain, nonatomic) MFSelectionGrabber *startGrabber; // @synthesize startGrabber=_startGrabber;
