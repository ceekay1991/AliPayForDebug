...
@class NSString, PBMapStringString, distinguishprodExchangeRateModelPB, distinguishprodTextModelPB;

@interface distinguishprodTranslateResultPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) distinguishprodTextModelPB *text; // @dynamic text;
