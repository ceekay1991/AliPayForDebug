...
@interface TBSDKRequest : NSObject <TBSDKConnectionDelegate, TBSDKProgressDelegate>
{
    ...
    double _mtopReqProcessT;
    double _mtopRspProcessT;
    double _mtopRspCbDispatchT;
    NSString *_requestId;
...
+ (void)initialize;
@property(nonatomic) _Bool isSGUnifiedEnabled; // @synthesize isSGUnifiedEnabled=_isSGUnifiedEnabled;
@property(copy, nonatomic) NSDictionary *securityFactors; // @synthesize securityFactors=_securityFactors;
@property(retain, nonatomic) NSString *requestId; // @synthesize requestId=_requestId;
@property(nonatomic) double mtopRspCbDispatchT; // @synthesize mtopRspCbDispatchT=_mtopRspCbDispatchT;
@property(nonatomic) double mtopRspProcessT; // @synthesize mtopRspProcessT=_mtopRspProcessT;
@property(nonatomic) double mtopReqProcessT; // @synthesize mtopReqProcessT=_mtopReqProcessT;
@property(copy, nonatomic) NSString *fullTraceID; // @synthesize fullTraceID=_fullTraceID;
...
@property(retain) NSMutableDictionary *custhomHeaders; // @synthesize custhomHeaders=_custhomHeaders;
...
- (void)request:(id)arg1 fullTraceData:(id)arg2;
