...
#import "APSyncDataManagerDelegate-Protocol.h"
#import "APSyncDirectDataManagerDelegate-Protocol.h"
#import "APSyncPBFactoryDelegate-Protocol.h"
...
+ (id)accessInstance;
+ (id)sharedInstance;
@property(nonatomic) int lastDispatchStatus; // @synthesize lastDispatchStatus=_lastDispatchStatus;
...
- (long long)processSaveTopicOplog:(id)arg1 keyDicId:(id)arg2 biz:(id)arg3 inDB:(id)arg4 logs:(id)arg5 context:(id)arg6;
- (long long)processSaveDispTopicOplog:(id)arg1 keyDicId:(id)arg2 bizSyncInfo:(id)arg3 biz:(id)arg4 logs:(id)arg5 context:(id)arg6;
- (void)dealWithPostResult:(long long)arg1 header:(id)arg2 biz:(id)arg3 hasMsg:(_Bool)arg4;
- (long long)processSaveDispatchTopicMsg:(id)arg1 keyDicId:(id)arg2 bizSyncInfo:(id)arg3 header:(id)arg4 type:(long long)arg5 logs:(id)arg6 context:(id)arg7;
...
- (id)oplogWithOp:(id)arg1 pushData:(id)arg2 keyDicId:(id)arg3 biz:(id)arg4 msgId:(id)arg5 context:(id)arg6;
- (void)addOplogData:(id)arg1 list:(id)arg2;
- (void)addPushData:(id)arg1 list:(id)arg2;
- (void)addAck:(id)arg1 list:(id)arg2 isRepeat:(_Bool)arg3;
- (long long)processSaveOplog:(id)arg1 keyDicId:(id)arg2 bizSyncInfo:(id)arg3 biz:(id)arg4 inDB:(id)arg5 context:(id)arg6;
- (long long)processSaveDispOplog:(id)arg1 keyDicId:(id)arg2 bizSyncInfo:(id)arg3 biz:(id)arg4 context:(id)arg5;
- (long long)processSaveDispatchMsg:(id)arg1 keyDicId:(id)arg2 bizSyncInfo:(id)arg3 header:(id)arg4 type:(long long)arg5 context:(id)arg6;
...
- (id)oplogToString:(id)arg1 biz:(id)arg2 keyDicId:(id)arg3 statIdList:(id)arg4 oldKey:(id)arg5 context:(id)arg6;
- (long long)dispatchOplogDir:(id)arg1 keyDicId:(id)arg2 statIdList:(id)arg3 oldKey:(id)arg4 context:(id)arg5;
...
- (void)send4001DataWithSyncKey:(long long)arg1 bizEnum:(long long)arg2 error:(id)arg3 errorCode:(long long)arg4 principalId:(id)arg5 appName:(id)arg6;
- (void)send4001DataWithSyncKey:(id)arg1 biz:(id)arg2 error:(id)arg3 errorCode:(long long)arg4 principalId:(id)arg5 appName:(id)arg6;
- (void)sendFaildNotifyDelegate:(id)arg1 biz:(id)arg2 appName:(id)arg3;
...
- (void)postCacheMessageWithBiz:(id)arg1 appName:(id)arg2;
- (id)oplogWithSyncData:(id)arg1 pushData:(id)arg2 keyDicId:(id)arg3 biz:(id)arg4 syncsMd:(id)arg5 newKey:(id)arg6 context:(id)arg7;
- (long long)addStatId:(id)arg1 biz:(id)arg2 statIdList:(id)arg3 keyDicId:(id)arg4 inDB:(id)arg5;
- (long long)processNotPersistenceSyncData:(id)arg1 keyDicId:(id)arg2 biz:(id)arg3 oldKey:(id)arg4 statIdList:(id)arg5 context:(id)arg6;
- (long long)processSKeySaveSyncData:(id)arg1 keyDicId:(id)arg2 biz:(id)arg3 inDB:(id)arg4 newKey:(id)arg5 oldKey:(id)arg6 statIdList:(id)arg7 context:(id)arg8;
- (id)msgIdFormat:(id)arg1 context:(id)arg2;
- (_Bool)logBiz:(id)arg1;
- (long long)saveDispatchOplog:(id)arg1 keyDicId:(id)arg2 newKey:(id)arg3 oldKey:(id)arg4 error:(id *)arg5 statIdList:(id)arg6 context:(id)arg7;
...
- (long long)processSaveDispatch:(id)arg1 keyDicId:(id)arg2 sKeyDic:(id)arg3 bizSyncInfo:(id)arg4 opcode:(id)arg5 header:(id)arg6 type:(long long)arg7 hasBucket:(_Bool)arg8 context:(id)arg9;
...
- (long long)processBucket:(id)arg1 keyDicId:(id)arg2 sKeyDic:(id)arg3 bucketKey:(id)arg4 header:(id)arg5 formCMD:(id)arg6 context:(id)arg7;
- (id)bucketTypeWithBucketInfo:(int)arg1 syncKey:(long long)arg2 appName:(id)arg3;
...
- (_Bool)verifyAppName:(id)arg1 context:(id)arg2;
...
- (_Bool)verifyBiz:(long long)arg1 biz:(id)arg2 appName:(id)arg3;
...
- (_Bool)hasUserId;
- (void)postSyncResult2DispatchStatus:(long long)arg1;
