...
@property(copy, nonatomic) NSDictionary *groupInfo; // @synthesize groupInfo=_groupInfo;
@property(copy, nonatomic) NSDictionary *monitorInfo; // @synthesize monitorInfo=_monitorInfo;
