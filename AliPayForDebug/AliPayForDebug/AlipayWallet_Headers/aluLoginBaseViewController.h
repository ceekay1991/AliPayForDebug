...
@class ALUActionSheet, ALULoginPageBuilder, APSecRDS, NSDictionary, NSMutableArray, NSMutableDictionary, NSNumber, NSString, UIImage, UILabel, UITextField, UIView, aluButton, aluLinkButton, aluLoginBizModel, aluLoginBox, aluRoundHeadImage;
...
@property(retain, nonatomic) NSString *exchangeLoginId; // @synthesize exchangeLoginId=_exchangeLoginId;
...
@property(retain, nonatomic) NSMutableArray *loginTypeArray; // @synthesize loginTypeArray=_loginTypeArray;
...
- (_Bool)isSupportFaceLoginType:(id)arg1;
- (void)cancelExchangeLoginType;
- (void)exchangeLoginType:(unsigned long long)arg1;
- (void)initLoginTypeArray:(unsigned long long)arg1;
- (void)checkoutTid;
- (_Bool)needToCheckTid;
- (_Bool)checkTidSwitch;
...
- (void)popToContainerVCAnimated:(_Bool)arg1;
...
- (void)becomeLoginIdFirstReponder;
...
- (void)executeAlipayToken:(id)arg1 scopeType:(long long)arg2;
