...
#import "SyncInfoDelegate-Protocol.h"
...
- (void)dealloc;
- (void)refreshSyncLan;
- (void)frameworkDidFinishRegionChange:(id)arg1;
- (void)frameworkWillRegionChange:(id)arg1;
...
- (_Bool)canNotifyPush:(id)arg1 pushInfo:(id)arg2;
...
- (void)webSocketInit;
- (void)reInitNetLibrary:(_Bool)arg1;
- (void)startAMNet;
- (void)accessInit;
