...
+ (void)showRegionControllerWithNavigationController:(id)arg1 backToViewController:(id)arg2 curSelectedRegion:(id)arg3 config:(id)arg4 customRegionDatas:(id)arg5 completionBlock:(CDUnknownBlockType)arg6;
