...
@interface mobileappcommonRealWeatherResponsePB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasHumidity; // @dynamic hasHumidity;
...
@property(readonly) _Bool hasTemperature; // @dynamic hasTemperature;
@property(readonly) _Bool hasWeather; // @dynamic hasWeather;
@property(readonly) _Bool hasWindDirection; // @dynamic hasWindDirection;
@property(readonly) _Bool hasWindPower; // @dynamic hasWindPower;
@property(retain, nonatomic) NSString *humidity; // @dynamic humidity;
...
@property(retain, nonatomic) NSString *windDirection; // @dynamic windDirection;
@property(retain, nonatomic) NSString *windPower; // @dynamic windPower;
