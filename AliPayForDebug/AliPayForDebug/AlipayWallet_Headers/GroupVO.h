...
@property(readonly) _Bool hasMaxAdminNum; // @dynamic hasMaxAdminNum;
...
@property(nonatomic) int maxAdminNum; // @dynamic maxAdminNum;
...
@property(nonatomic) int silentStatus; // @dynamic silentStatus;
