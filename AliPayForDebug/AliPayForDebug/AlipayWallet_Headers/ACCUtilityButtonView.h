...
@class ACCSwipeTableViewCell, NSArray, NSLayoutConstraint, NSMutableArray;

@interface ACCUtilityButtonView : UIView
{
    ACCSwipeTableViewCell *_parentCell;
...
@property(readonly, nonatomic) __weak ACCSwipeTableViewCell *parentCell; // @synthesize parentCell=_parentCell;
- (void).cxx_destruct;
