...
@protocol CTGrowingTextViewDelegate, CTGrowingTextViewSizeDelegate, CTPasteboardDelegate;
...
@interface CTGrowingTextView : UIView <UITextViewDelegate>
{
    ...
    id <CTGrowingTextViewSizeDelegate> _sizeDelegate;
...
@property(nonatomic) __weak id <CTGrowingTextViewSizeDelegate> sizeDelegate; // @synthesize sizeDelegate=_sizeDelegate;
