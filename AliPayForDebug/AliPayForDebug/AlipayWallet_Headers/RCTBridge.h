...
@class NSArray, NSDictionary, NSLock, NSString, NSURL, RCTAccessibilityManager, RCTPerformanceLogger, RCTUIManager;
...
@property(readonly, nonatomic, getter=isJSLoadedNotiPosted) _Bool jSLoadedNotiPosted; // @synthesize jSLoadedNotiPosted=_jSLoadedNotiPosted;
...
- (id)eventDispatcher;
@property(readonly, nonatomic) NSObject *redBox;
