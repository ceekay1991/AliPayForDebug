...
@interface distinguishprodSignResultPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasSignBizMsg; // @dynamic hasSignBizMsg;
...
@property(retain, nonatomic) NSString *signBizMsg; // @dynamic signBizMsg;
