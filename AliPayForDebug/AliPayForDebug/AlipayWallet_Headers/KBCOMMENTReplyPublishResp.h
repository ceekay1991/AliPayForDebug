...
@class KBCOMMENTReplyRpcInfo, NSString;

@interface KBCOMMENTReplyPublishResp : NSObject
{
    _Bool _success;
    NSString *_resultCode;
    NSString *_resultDesc;
    NSString *_resultView;
    KBCOMMENTReplyRpcInfo *_replyRpcInfo;
}

@property(retain, nonatomic) KBCOMMENTReplyRpcInfo *replyRpcInfo; // @synthesize replyRpcInfo=_replyRpcInfo;
