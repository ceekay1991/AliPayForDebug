...
@class APContactInfo, AUInputBox, CTGrowingTextView, NSArray, NSMutableArray, NSString, SPBorderContainer, SPRemarkSettingDataManager, SPSocialTagDisplayView, UIButton, UILabel, UIScrollView, UITextField, UIView;
...
@interface SCProfileSetRemarkController : SCTableViewBaseController <UITextFieldDelegate, CTGrowingTextViewDelegate>
{
    ...
    AUInputBox *_addTelInputBox;
    AUInputBox *_animationInputBox;
