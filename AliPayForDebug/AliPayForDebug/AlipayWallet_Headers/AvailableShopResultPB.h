...
@interface AvailableShopResultPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSArray *availableShopList; // @dynamic availableShopList;
...
@property(readonly) _Bool hasShopcnt; // @dynamic hasShopcnt;
@property(readonly) _Bool hasSuccess; // @dynamic hasSuccess;
@property(readonly) _Bool hasTaxiTemplateUrl; // @dynamic hasTaxiTemplateUrl;
...
@property(retain, nonatomic) NSString *shopcnt; // @dynamic shopcnt;
@property(nonatomic) _Bool success; // @dynamic success;
@property(retain, nonatomic) NSString *taxiTemplateUrl; // @dynamic taxiTemplateUrl;
