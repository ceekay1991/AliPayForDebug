...
@class ALAsset, NSDate, NSDictionary, NSString, NSURL, PHAsset, UIImage;
...
- (void)postCompleteNotification:(id)arg1;
- (void)postLoadingProgressNotification:(double)arg1 withInCloud:(_Bool)arg2;
- (void)postHideProgressNotificationWithInCloud:(_Bool)arg1;
- (void)postStartDownloadNotificationWithInCloud:(_Bool)arg1;
- (void)imageLoadingComplete:(_Bool)arg1;
