...
@interface mobilesearchPromotionInfoHybirdPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) PBMapStringString *extObj; // @dynamic extObj;
@property(readonly) _Bool hasCode; // @dynamic hasCode;
@property(readonly) _Bool hasExtObj; // @dynamic hasExtObj;
