...
@class CADisplayLink, MAMapEngine, NSNumber, NSString, UIBezierPath, UIImage;
...
@interface MAMapRender : GLKView <MAMapEngineRenderDelegate>
{
    ...
    long long _customFrameInterval;
    NSString *_runLoopMode;
    _Bool _isStopRenderByAuth;
    NSNumber *_AppActiveState;
...
- (void)internalRenderWithDuration:(double)arg1 andFrameInterval:(long long)arg2;
- (void)stopRenderByAuth:(_Bool)arg1;
