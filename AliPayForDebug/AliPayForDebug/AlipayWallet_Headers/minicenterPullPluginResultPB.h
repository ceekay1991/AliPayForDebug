...
@interface minicenterPullPluginResultPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasPb_hasPermission; // @dynamic hasPb_hasPermission;
...
@property(nonatomic) _Bool pb_hasPermission; // @dynamic pb_hasPermission;
