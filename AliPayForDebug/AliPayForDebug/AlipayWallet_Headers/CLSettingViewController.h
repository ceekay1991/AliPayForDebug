...
@class APSKLaunchpad, CLFloatTipView, COMConfigItem, COMQueryCommunityResp, NSMutableArray, NSString, UIImage, UIImageView, UILabel, UITableView, UIView;
@protocol CLSettingVCDataSyncDelegate;
...
@interface CLSettingViewController : DTViewController <UITableViewDelegate, UITableViewDataSource, UIActionSheetDelegate, BEEPhotoBrowserDelegate, APSKLaunchpadDelegate, CLEditNickNameDelegate>
{
    ...
    NSString *_sourceId;
    _Bool _privateRemindDidShow;
    _Bool _addtoScreenRemindDidShow;
    _Bool _topicManageRemindNeedUpdate;
    CLFloatTipView *_tipView;
    id <CLSettingVCDataSyncDelegate> _dataDelegate;
...
@property(nonatomic) __weak id <CLSettingVCDataSyncDelegate> dataDelegate; // @synthesize dataDelegate=_dataDelegate;
- (void).cxx_destruct;
...
- (void)addClubIconToHomeScreen:(id)arg1;
