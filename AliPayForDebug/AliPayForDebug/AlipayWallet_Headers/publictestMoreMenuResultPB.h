...
@class NSString, publictestMoreMenuVoPB;

@interface publictestMoreMenuResultPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasMenuData; // @dynamic hasMenuData;
...
@property(retain, nonatomic) publictestMoreMenuVoPB *menuData; // @dynamic menuData;
