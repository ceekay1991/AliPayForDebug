...
#import "SPIPluggableMarginSetCard-Protocol.h"
#import "UITextFieldDelegate-Protocol.h"

@class APContactInfo, AUSwitch, NSArray, NSNumber, NSString, SPStrangerChatView, SUImageView, UIButton, UIControl, UIImageView, UILabel;
...
@interface SPPrimaryInfoView : UIView <SPIPluggableMarginSetCard, UITextFieldDelegate>
{
    ...
    _Bool _didAddStageEntryExposurePoint;
    _Bool _didAddBtnOtherAddMe;
    UIButton *_bgAreaBtn;
    UIButton *_headView;
    UIImageView *_userGradeView;
    UILabel *_nameView;
    UIButton *_stageEntryIconBtn;
    UIButton *_stageEntryBubbleBtn;
    ...
    SUImageView *_stageEntryIconView;
...
@property(nonatomic) _Bool didAddBtnOtherAddMe; // @synthesize didAddBtnOtherAddMe=_didAddBtnOtherAddMe;
@property(nonatomic) _Bool didAddStageEntryExposurePoint; // @synthesize didAddStageEntryExposurePoint=_didAddStageEntryExposurePoint;
...
@property(retain, nonatomic) SUImageView *stageEntryIconView; // @synthesize stageEntryIconView=_stageEntryIconView;
...
@property(retain, nonatomic) AUSwitch *showRealNameSwitch; // @synthesize showRealNameSwitch=_showRealNameSwitch;
...
@property(retain, nonatomic) UIButton *stageEntryBubbleBtn; // @synthesize stageEntryBubbleBtn=_stageEntryBubbleBtn;
@property(retain, nonatomic) UIButton *stageEntryIconBtn; // @synthesize stageEntryIconBtn=_stageEntryIconBtn;
...
- (_Bool)handlePrivateMsgEvent:(id)arg1;
...
- (id)makeButtonsArea;
- (id)makeBubbleButtonWithText:(id)arg1;
