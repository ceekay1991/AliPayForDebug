...
@interface VideoSetting : NSObject <APMConfigUpdateProtocol>
{
    _Bool _generateThumbnailFromVideo;
    _Bool _usingPHLibraryStoreAlbum;
    _Bool _updateLocked;
...
@property(nonatomic) _Bool usingPHLibraryStoreAlbum; // @synthesize usingPHLibraryStoreAlbum=_usingPHLibraryStoreAlbum;
