...
@class AUDragLoadingView, GIFTPRODGiftCrowdFlowInfoResult, NSMutableArray, NSString, REARImageBrowser, REButton, RECodeSharePopViewManager, REVerifyUserIdentityInterceptor, UIImage, UILabel;
...
@property(nonatomic) _Bool fromSharingProcess; // @synthesize fromSharingProcess=_fromSharingProcess;
- (void).cxx_destruct;
