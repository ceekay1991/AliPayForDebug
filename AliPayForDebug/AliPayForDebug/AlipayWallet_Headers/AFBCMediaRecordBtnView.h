...
@protocol AFBCMediaRecordBtnViewDelegate;

@interface AFBCMediaRecordBtnView : UIView
{
    NSTimer *_timer;
    int _recordSatus;
    id <AFBCMediaRecordBtnViewDelegate> _delegate;
    double _progress;
...
@property(nonatomic) __weak id <AFBCMediaRecordBtnViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
- (void)dealloc;
