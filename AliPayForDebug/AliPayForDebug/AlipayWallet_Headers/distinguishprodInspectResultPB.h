...
@interface distinguishprodInspectResultPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasDefaultUrl; // @dynamic hasDefaultUrl;
@property(readonly) _Bool hasExtraInfo; // @dynamic hasExtraInfo;
@property(readonly) _Bool hasIsAccessible; // @dynamic hasIsAccessible;
...
@property(nonatomic) _Bool isAccessible; // @dynamic isAccessible;
