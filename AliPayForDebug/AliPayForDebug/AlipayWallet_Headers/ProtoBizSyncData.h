...
@interface ProtoBizSyncData : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    ...
    _Bool _hasDeliverWithNoSeq;
    _Bool _hasMore;
    _Bool _multiDevice;
    _Bool _persistentBiz;
    _Bool _deliverWithNoSeq;
    int _bizType;
    int _pf;
    long long _syncKey;
...
@property(nonatomic) _Bool deliverWithNoSeq; // @synthesize deliverWithNoSeq=_deliverWithNoSeq;
...
@property(readonly) _Bool hasDeliverWithNoSeq; // @synthesize hasDeliverWithNoSeq=_hasDeliverWithNoSeq;
