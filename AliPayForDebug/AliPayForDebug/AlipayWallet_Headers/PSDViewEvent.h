...
@class NSDictionary, NSString, PSDKernel, WKWebViewConfiguration;
...
+ (id)createEvent;
+ (id)allEvent;
@property(nonatomic) __weak PSDKernel *parentObject; // @synthesize parentObject=_parentObject;
