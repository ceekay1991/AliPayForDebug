...
@class AUButton, NSDictionary, SPQRCodeModel, TTTAttributedLabel, UIImageView, UIView;
...
@interface SPQRCodeShareViewController : SPBaseViewController
{
    ...
    AUButton *_gotoDetailBtn;
    NSDictionary *_formatDict;
}

@property(retain, nonatomic) NSDictionary *formatDict; // @synthesize formatDict=_formatDict;
@property(retain, nonatomic) AUButton *gotoDetailBtn; // @synthesize gotoDetailBtn=_gotoDetailBtn;
