...
@class BisBehavLog, NSDictionary, NSString, ZDocProtocolModel;

@interface ZDocBehavLogManager : NSObject
{
    BisBehavLog *_behavLog;
    ZDocProtocolModel *_protocol;
...
@property(retain, nonatomic) ZDocProtocolModel *protocol; // @synthesize protocol=_protocol;
