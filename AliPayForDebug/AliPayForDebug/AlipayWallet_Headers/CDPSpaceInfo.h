...
@interface CDPSpaceInfo : NSObject <NSCoding>
{
    ...
    NSDictionary *_spaceBizInfo;
    NSString *_isBizHighCode;
}
...
+ (void)downLoadPics:(id)arg1 lotties:(id)arg2 videos:(id)arg3 spaceCode:(id)arg4 complete:(CDUnknownBlockType)arg5;
+ (void)preloadVideo:(id)arg1 completionOnMainQueue:(CDUnknownBlockType)arg2;
+ (void)preloadPicture:(id)arg1 completionOnMainQueue:(CDUnknownBlockType)arg2;
@property(retain, nonatomic) NSString *isBizHighCode; // @synthesize isBizHighCode=_isBizHighCode;
@property(retain, nonatomic) NSDictionary *spaceBizInfo; // @synthesize spaceBizInfo=_spaceBizInfo;
...
- (void).cxx_destruct;
- (_Bool)needShowFullView;
- (void)setSpaceInfoIdsForBizCodes:(id)arg1 appId:(id)arg2 h5ViewId:(id)arg3;
- (_Bool)needCheckSpaceFatigue;
- (id)h5LaunchParams:(id)arg1;
- (void)setLogExtInfoForObject;
- (_Bool)shouldCheckLocalPic;
- (void)addSpaceObjectExt:(id)arg1;
- (void)addSpaceBizExtInfo:(id)arg1;
- (_Bool)addSpaceCloseTimes;
...
- (id)getUsefulSpaceObjectInfo:(id)arg1 onlyMaxCount:(_Bool)arg2;
- (void)setSpaceCodeForObjectInfo;
