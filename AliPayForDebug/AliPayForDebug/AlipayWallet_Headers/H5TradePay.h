...
- (void)callSafepayForURL:(id)arg1 extraOrder:(id)arg2 extParams:(id)arg3;
- (id)appenv;
- (void)callSafepayForOrderstr:(id)arg1 extParams:(id)arg2 completeBlock:(CDUnknownBlockType)arg3;
- (void)callSafepayWithParnter:(id)arg1 externToken:(id)arg2 outTradeNo:(id)arg3 bizType:(id)arg4 bizNo:(id)arg5 bizSubType:(id)arg6 bizContext:(id)arg7 extParams:(id)arg8 canShowPayResult:(_Bool)arg9 completeBlock:(CDUnknownBlockType)arg10;
