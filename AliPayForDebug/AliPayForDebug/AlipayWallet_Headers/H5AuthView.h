...
@class AUButton, AUTableView, NSArray, NSString, TTTAttributedLabel, UILabel, UIView;
...
@property(retain, nonatomic) AUButton *rejectBtn; // @synthesize rejectBtn=_rejectBtn;
@property(retain, nonatomic) UIView *thinLineL; // @synthesize thinLineL=_thinLineL;
@property(retain, nonatomic) UIView *thinLineU; // @synthesize thinLineU=_thinLineU;
@property(nonatomic) double authListMaxLength; // @synthesize authListMaxLength=_authListMaxLength;
...
@property(retain, nonatomic) AUTableView *listView; // @synthesize listView=_listView;
