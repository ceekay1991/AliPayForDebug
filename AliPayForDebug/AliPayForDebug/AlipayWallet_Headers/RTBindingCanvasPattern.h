...
@class APGCanvasPattern;

@interface RTBindingCanvasPattern : RTBinding
{
    APGCanvasPattern *_pattern;
}

+ (struct OpaqueJSClass *)createJSClassWithPropertyAndFunctions;
@property(readonly, nonatomic) APGCanvasPattern *pattern; // @synthesize pattern=_pattern;
- (void).cxx_destruct;
- (void)dealloc;
