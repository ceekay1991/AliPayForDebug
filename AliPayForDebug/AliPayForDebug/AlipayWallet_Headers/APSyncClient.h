...
@interface APSyncClient : NSObject <APSyncRequestDelegate, SyncDelayRequestDelegate>
{
    ...
    NSMutableDictionary *_listenersMultipleAppHash;
...
@property(retain, nonatomic) NSMutableDictionary *listenersMultipleAppHash; // @synthesize listenersMultipleAppHash=_listenersMultipleAppHash;
...
- (id)listenerWithBiz:(id)arg1 appName:(id)arg2;
- (void)logmsgPara1:(id)arg1 oplog:(id)arg2;
- (id)sendSyncMsg:(id)arg1 needCallback:(_Bool)arg2;
- (void)notifyBizHadSended:(id)arg1 appName:(id)arg2;
