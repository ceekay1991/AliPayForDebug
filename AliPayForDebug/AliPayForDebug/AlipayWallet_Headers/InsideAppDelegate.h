...
#import "ANXSchemeHandlerDelegate-Protocol.h"
#import "DTMicroApplicationDelegate-Protocol.h"

@class ANXSchemeHandler, NSString, UIViewController;

@interface InsideAppDelegate : NSObject <ANXSchemeHandlerDelegate, DTMicroApplicationDelegate>
{
    UIViewController *_rootController;
    ANXSchemeHandler *_schemeHandler;
}

@property(retain, nonatomic) ANXSchemeHandler *schemeHandler; // @synthesize schemeHandler=_schemeHandler;
...
- (void)schemeHandlerNeedShowRootVC:(id)arg1;
