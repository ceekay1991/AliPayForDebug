...
+ (Class)itemPromotionInfosElementClass;
+ (Class)majorInfosElementClass;
...
@property(retain, nonatomic) NSArray *itemPromotionInfos; // @synthesize itemPromotionInfos=_itemPromotionInfos;
@property(retain, nonatomic) NSArray *majorInfos; // @synthesize majorInfos=_majorInfos;
