...
@interface finscbffTradeUrlResponsePB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSString *gotoUrl; // @dynamic gotoUrl;
@property(readonly) _Bool hasGotoUrl; // @dynamic hasGotoUrl;
