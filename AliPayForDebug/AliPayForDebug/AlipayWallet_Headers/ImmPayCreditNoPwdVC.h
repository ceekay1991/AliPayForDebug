...
@class ImmPaySettingService, MQPAlertView, NSArray, NSString, UILabel, UISwitch, UITableView, UIView;
...
@interface ImmPayCreditNoPwdVC : MMPAutoRotateVC <UITableViewDataSource, UITableViewDelegate>
{
    ...
    UILabel *_tipLabel;
    UIView *_footView;
    MQPAlertView *_offlineAlert;
    UIView *_iconView;
}

@property(retain, nonatomic) UIView *iconView; // @synthesize iconView=_iconView;
@property(retain, nonatomic) MQPAlertView *offlineAlert; // @synthesize offlineAlert=_offlineAlert;
...
- (void)triggerSwitchValueChanged:(id)arg1;
