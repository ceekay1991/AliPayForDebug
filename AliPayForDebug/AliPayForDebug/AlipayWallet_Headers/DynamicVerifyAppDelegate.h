...
@class APDynamicDeploymentBandageInteraction, APDynamicDeploymentBundleInteraction, APDynamicDeploymentFrameworkInteraction, NSString, UIViewController;
...
@interface DynamicVerifyAppDelegate : NSObject <DTMicroApplicationDelegate>
{
    ...
    APDynamicDeploymentFrameworkInteraction *_frameworkInteraction;
}

@property(retain, nonatomic) APDynamicDeploymentFrameworkInteraction *frameworkInteraction; // @synthesize frameworkInteraction=_frameworkInteraction;
