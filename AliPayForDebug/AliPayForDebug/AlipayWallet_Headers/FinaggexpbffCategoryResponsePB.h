...
@class FinaggexpbffCategoryResultPB, NSString;

@interface FinaggexpbffCategoryResponsePB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) FinaggexpbffCategoryResultPB *result; // @dynamic result;
