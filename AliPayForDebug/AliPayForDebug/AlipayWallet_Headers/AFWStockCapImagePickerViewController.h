...
@class APVideoRecorder, BCMediaRecordBtnView, NSDictionary, NSMutableArray, NSString, UIButton, UILabel, UIView;
@protocol BCMaskViewDelegate;

@interface AFWStockCapImagePickerViewController : DTViewController <APVideoRecorderDelegate, BCMediaRecordBtnViewDelegate>
{
    _Bool _enableRecordBtn;
    _Bool _isLandscape;
    _Bool _firstLoad;
...
@property(nonatomic) _Bool faceSide; // @synthesize faceSide=_faceSide;
...
@property(nonatomic) _Bool enableRecordBtn; // @synthesize enableRecordBtn=_enableRecordBtn;
