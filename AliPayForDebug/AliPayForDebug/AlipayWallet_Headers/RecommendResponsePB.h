...
@class NSString, RecommendItemPB;

@interface RecommendResponsePB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasRecommend; // @dynamic hasRecommend;
...
@property(retain, nonatomic) RecommendItemPB *recommend; // @dynamic recommend;
