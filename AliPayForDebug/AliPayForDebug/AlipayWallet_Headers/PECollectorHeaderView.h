...
@class AUAmountLabelText, NSString, PEGradientLabel, TRANSFERPRODQueryReceiverInfoResp, UIImageView, UILabel;
...
@interface PECollectorHeaderView : UIView
{
    ...
    AUAmountLabelText *_amountLabel;
    UILabel *_memoLabel;
...
@property(retain, nonatomic) AUAmountLabelText *amountLabel; // @synthesize amountLabel=_amountLabel;
