...
@interface miniprodMiniAppKeepQueryResultPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasPb_hasKeep; // @dynamic hasPb_hasKeep;
...
@property(retain, nonatomic) NSArray *keepMiniAppInfoResultList; // @dynamic keepMiniAppInfoResultList;
@property(nonatomic) _Bool pb_hasKeep; // @dynamic pb_hasKeep;
