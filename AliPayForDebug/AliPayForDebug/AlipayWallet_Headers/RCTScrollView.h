...
@class NSHashTable, NSMutableArray, NSString, RCTCustomScrollView, RCTEventDispatcher, TNBounceTopBottomColorHandler, UIScrollView, UIView;
...
@interface RCTScrollView : RCTView <UIScrollViewDelegate, RCTScrollableProtocol, RCTAutoInsetsProtocol>
{
    ...
    _Bool _isAnimating;
    TNBounceTopBottomColorHandler *_bounceColorHandler;
...
- (void).cxx_destruct;
- (void)tn_viewControllerChanged:(id)arg1;
...
- (void)tn_refreshControlPauseAnimation;
- (void)tn_refreshControlResumeAnimation;
- (id)tn_bounceBottomBackgroundColor;
- (void)tn_setBounceBottomBackgroundColor:(id)arg1;
- (id)tn_bounceTopBackgroundColor;
- (void)tn_setBounceTopBackgroundColor:(id)arg1;
- (unsigned long long)tn_refreshControlViewType;
- (void)tn_setRefreshControlViewType:(unsigned long long)arg1;
