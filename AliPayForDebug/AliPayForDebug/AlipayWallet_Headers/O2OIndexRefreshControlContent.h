...
@interface O2OIndexRefreshControlContent : UIView <VZRefreshControlContent>
{
...
@property(readonly, nonatomic) AULoadingIndicatorView *loadingIndicator; // @synthesize loadingIndicator=_loadingIndicator;
- (void).cxx_destruct;
