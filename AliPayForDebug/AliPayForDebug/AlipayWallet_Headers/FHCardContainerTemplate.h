...
@class ALTCardContainer, FHCardContainerCell, FHCellSerperatorModel, NSString, UITableView, UIView;

@interface FHCardContainerTemplate : FHBaseTemplate <ALTCardContainerDelegate>
{
    _Bool _showOnScreen;
    _Bool _noBorder;
