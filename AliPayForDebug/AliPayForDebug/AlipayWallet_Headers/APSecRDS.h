...
@class AliSecXDeviceSensorInfo, NSDictionary, NSString, RDSBehaviorManager, RDSSecurityCheck;
...
@interface APSecRDS : NSObject
{
    ...
    NSDictionary *_cachedWifiInfo;
}

+ (id)innerDeviceRiskData;
+ (int)getDeviceRiskSwitch;
+ (id)innerWuaData;
+ (id)getMiniWuaData;
@property(retain) NSDictionary *cachedWifiInfo; // @synthesize cachedWifiInfo=_cachedWifiInfo;
...
- (_Bool)getRDSSensorSwitchConfig;
- (id)init;
