...
- (void)setupCurSearchIndexInfo:(id)arg1 cityDic:(id)arg2;
- (id)buildSearchIndexWithPageModel:(id)arg1;
- (void)buildSearchIndexWithDataModelList:(id)arg1 completion:(CDUnknownBlockType)arg2;
