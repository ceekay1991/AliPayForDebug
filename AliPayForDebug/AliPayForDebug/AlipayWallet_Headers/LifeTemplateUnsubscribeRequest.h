...
@interface LifeTemplateUnsubscribeRequest : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    _Bool _hasPublicId;
    _Bool _hasAction;
    _Bool _hasTargetType;
    NSString *_publicId;
    NSString *_action;
...
@property(readonly) _Bool hasTargetType; // @synthesize hasTargetType=_hasTargetType;
