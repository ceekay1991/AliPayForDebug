...
@class NSArray, NSString, PBMapStringString, distinguishprodCateRecResModelPB, distinguishprodRecRegionModelPB, distinguishprodResScanQueryResponsePB, distinguishprodYearResModelPB;
...
@property(readonly) _Bool hasYearResModel; // @dynamic hasYearResModel;
@property(retain, nonatomic) NSString *openAppId; // @dynamic openAppId;
@property(retain, nonatomic) NSArray *recObjs; // @dynamic recObjs;
@property(retain, nonatomic) distinguishprodRecRegionModelPB *recRegion; // @dynamic recRegion;
...
@property(retain, nonatomic) distinguishprodYearResModelPB *yearResModel; // @dynamic yearResModel;
