...
@property(nonatomic) _Bool isPenetrateResponder; // @synthesize isPenetrateResponder=_isPenetrateResponder;
...
- (void)isAutoPenetrateNavigationBarHitTest:(_Bool)arg1;
