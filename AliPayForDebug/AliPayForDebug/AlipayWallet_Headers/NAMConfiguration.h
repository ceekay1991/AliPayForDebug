...
@protocol NAMAppInterface, NAMCreditProtocol, NAMDataStorageProtocol, NAMDownloadProtocol, NAMDynamicConfigProtocol, NAMLogProtocol, NAMRequestProtocol, NAMTinyAppConfigProtocol, NAMZipArchiveProtocol;
...
@interface NAMConfiguration : NSObject
{
    ...
    id <NAMCreditProtocol> _creditManager;
    id <NAMTinyAppConfigProtocol> _tinyappConfigManager;
}

+ (id)allocPrivate;
+ (id)defaultConfiguration;
+ (id)defaultConfiguration;
@property(retain, nonatomic) id <NAMTinyAppConfigProtocol> tinyappConfigManager; // @synthesize tinyappConfigManager=_tinyappConfigManager;
@property(retain, nonatomic) id <NAMCreditProtocol> creditManager; // @synthesize creditManager=_creditManager;
