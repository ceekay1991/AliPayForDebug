...
@interface MSTerminalCheckResponsePB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasNeedDelLogin; // @dynamic hasNeedDelLogin;
@property(readonly) _Bool hasPromptTxt; // @dynamic hasPromptTxt;
...
@property(retain, nonatomic) NSString *needDelLogin; // @dynamic needDelLogin;
@property(retain, nonatomic) NSString *promptTxt; // @dynamic promptTxt;
