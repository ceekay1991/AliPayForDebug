...
@interface AFWFinancePotTradePluginAppDelegate : NSObject <DTMicroApplicationDelegate>
{
...
- (void).cxx_destruct;
- (void)clearCookie;
- (void)openWithSafeContainer:(id)arg1;
- (void)openWithNebulaContainer:(id)arg1;
