...
@interface finscbffPortfolioCheckResultPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSArray *inList; // @dynamic inList;
@property(retain, nonatomic) NSArray *outList; // @dynamic outList;
