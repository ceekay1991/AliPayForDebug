...
@class NSString, mfinquotationprodBidAskLevelPB;

@interface mfinquotationprodBidAskLevelResultPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) mfinquotationprodBidAskLevelPB *value; // @dynamic value;
