...
@protocol SocialAPhotoBrowserDelegate;
...
@interface SocialAPhotoBrowser : NSObject <BEEPhotoBrowserDelegate>
{
    ...
    unsigned long long _sharePhotoTag;
...
@property(nonatomic) unsigned long long sharePhotoTag; // @synthesize sharePhotoTag=_sharePhotoTag;
...
- (id)mPopMenuHelper;
- (void)shareFeed2Friend:(id)arg1 emotionModel:(id)arg2;
- (void)shareFeed2Friend:(id)arg1 photo:(id)arg2 controller:(id)arg3;
