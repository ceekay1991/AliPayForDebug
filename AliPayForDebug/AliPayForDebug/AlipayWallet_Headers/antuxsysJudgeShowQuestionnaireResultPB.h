...
@interface antuxsysJudgeShowQuestionnaireResultPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasShowFlag; // @dynamic hasShowFlag;
...
@property(nonatomic) _Bool showFlag; // @dynamic showFlag;
