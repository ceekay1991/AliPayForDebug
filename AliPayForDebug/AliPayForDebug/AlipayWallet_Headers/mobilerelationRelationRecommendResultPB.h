...
@interface mobilerelationRelationRecommendResultPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasShowRecommendCode; // @dynamic hasShowRecommendCode;
@property(readonly) _Bool hasSuccess; // @dynamic hasSuccess;
@property(retain, nonatomic) NSString *queryNo; // @dynamic queryNo;
@property(retain, nonatomic) NSArray *recommendUserInfoList; // @dynamic recommendUserInfoList;
@property(nonatomic) int resultCode; // @dynamic resultCode;
@property(retain, nonatomic) NSString *resultDesc; // @dynamic resultDesc;
@property(retain, nonatomic) NSString *showRecommendCode; // @dynamic showRecommendCode;
