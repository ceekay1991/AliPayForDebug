...
@interface publictestUserConfigResultPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSArray *projectList; // @dynamic projectList;
...
@property(retain, nonatomic) NSArray *shieldWaspIconDisplayList; // @dynamic shieldWaspIconDisplayList;
@property(retain, nonatomic) NSArray *unScreenShotList; // @dynamic unScreenShotList;
