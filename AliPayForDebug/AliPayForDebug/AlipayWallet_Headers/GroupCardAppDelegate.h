...
@interface GroupCardAppDelegate : NSObject <AUDialogDelegate, DTMicroApplicationDelegate>
{
...
- (void).cxx_destruct;
- (void)justshowLoadingAndFetchIndexRpc:(CDUnknownBlockType)arg1;
- (void)justShowDBData:(CDUnknownBlockType)arg1;
- (void)closeXiaohuaAndFetchIndexRpcOnCompletion:(CDUnknownBlockType)arg1;
