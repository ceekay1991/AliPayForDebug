...
@interface mobilerelationSessionUserBlackedListResultPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSArray *blackedMerchantList; // @dynamic blackedMerchantList;
