...
@interface RMDownloadModel : NSObject
{
    ...
    double _maxBgFileSize;
}

+ (id)sharedInstance;
@property(nonatomic) double maxBgFileSize; // @synthesize maxBgFileSize=_maxBgFileSize;
...
- (id)downloadListByPriorityForBgTask:(_Bool)arg1;
- (_Bool)canDownloadTask:(id)arg1 isBgTask:(_Bool)arg2;
