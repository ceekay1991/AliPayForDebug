...
@class FWRootViewController, NSString;

@interface FortuneWorkbenchAppDelegate : NSObject <DTMicroApplicationDelegate>
{
    FWRootViewController *_rootController;
}

@property(retain, nonatomic) FWRootViewController *rootController; // @synthesize rootController=_rootController;
- (void).cxx_destruct;
