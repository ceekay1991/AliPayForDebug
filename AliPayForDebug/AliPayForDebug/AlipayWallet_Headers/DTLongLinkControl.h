...
#import "DTLongLinkAsyncDelegate-Protocol.h"
#import "DTLonglinkDataDispatchDelegate-Protocol.h"

@class NSString, NSTimer;
@protocol SyncInfoDelegate;
...
- (void).cxx_destruct;
- (void)regionChange:(long long)arg1 changeInfo:(id)arg2;
- (void)dealWithRegionChange:(long long)arg1 changeInfo:(id)arg2;
