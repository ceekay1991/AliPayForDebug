...
#import "APNumPwdInputViewDelegate-Protocol.h"

@class APNumPwdInputView, AUButton, NSString, UIButton, UIImageView, UILabel;
...
@interface APNumPwdPopupView : UIView <APNumPwdInputViewDelegate>
{
    ...
    AUButton *_topRightButton;
}

+ (double)subtitleViewWidth;
@property(retain, nonatomic) AUButton *topRightButton; // @synthesize topRightButton=_topRightButton;
...
@property(nonatomic) __weak AUButton *confirmBtn; // @synthesize confirmBtn=_confirmBtn;
@property(nonatomic) __weak AUButton *cancelBtn; // @synthesize cancelBtn=_cancelBtn;
