...
@class NSArray, NSString, UIImageView, UIPanGestureRecognizer, UITapGestureRecognizer;
...
+ (id)presentWindow;
+ (id)showAtPostion:(struct CGPoint)arg1 items:(id)arg2 bizType:(id)arg3 scalingModel:(id)arg4;
+ (id)showAtPostion:(struct CGPoint)arg1 items:(id)arg2 bizType:(id)arg3;
