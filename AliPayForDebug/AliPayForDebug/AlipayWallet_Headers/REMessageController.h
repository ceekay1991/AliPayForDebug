...
#import "REMoreFooterViewDelegate-Protocol.h"
#import "RERouterDelegate-Protocol.h"
#import "REUSegmentViewDelegate-Protocol.h"
#import "UITableViewDataSource-Protocol.h"
#import "UITableViewDelegate-Protocol.h"

@class APBarButtonItem, APPickerView, NSArray, NSMutableArray, NSString, REActionSheetInterceptor, REMoreFooterView, RESelfTotalSummaryView, REUSegmentView, UIButton, UIRefreshControl, UISegmentedControl, UITableView, UITapGestureRecognizer, UIView;

@interface REMessageController : REBaseViewController <UITableViewDataSource, UITableViewDelegate, RERouterDelegate, REMoreFooterViewDelegate, REErrorViewDelegate, APPickerDelegate, REUSegmentViewDelegate>
{
    ...
    REUSegmentView *_segmentView;
}

@property(retain, nonatomic) REUSegmentView *segmentView; // @synthesize segmentView=_segmentView;
...
- (void)segmentView:(id)arg1 didSelectedItem:(int)arg2;
