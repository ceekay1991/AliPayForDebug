...
@interface mobilerelationSessionMerchantBlackedListResultPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSArray *blackeduserList; // @dynamic blackeduserList;
