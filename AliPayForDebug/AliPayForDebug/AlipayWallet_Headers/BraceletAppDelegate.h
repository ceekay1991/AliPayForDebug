...
@class NSString, SWViewController;

@interface BraceletAppDelegate : WearalbeAppDelegate <DTMicroApplicationDelegate>
{
    SWViewController *_rootController;
}

@property(retain, nonatomic) SWViewController *rootController; // @synthesize rootController=_rootController;
- (void).cxx_destruct;
