...
- (void)userLogInOut:(_Bool)arg1 userId:(NSString *)arg2 cachedSessionId:(NSString *)arg3 extInfo:(NSDictionary *)arg4;
...
- (void)sendHead:(NSDictionary *)arg1 body:(NSData *)arg2 channel:(long long)arg3 dataId:(unsigned long long)arg4 passSpanner:(_Bool)arg5 needRetry:(_Bool)arg6 forwardIP:(unsigned int)arg7 canHttp:(_Bool)arg8 canZstd:(_Bool)arg9 extraParams:(NSDictionary *)arg10;
