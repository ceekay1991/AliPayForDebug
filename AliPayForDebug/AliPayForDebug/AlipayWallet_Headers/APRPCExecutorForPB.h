...
- (void)changeToInternationalSite;
- (void)executeBlockOnReportQueue:(CDUnknownBlockType)arg1;
- (void)executeBlockOnRPCQueue:(CDUnknownBlockType)arg1;
- (id)dispatchRPC:(id)arg1 rpcParamDic:(id)arg2;
- (void)executeRPC:(id)arg1 showLoading:(_Bool)arg2 needChangeGateWay:(_Bool)arg3 needChangeFaceLoginOperationType:(_Bool)arg4 callback:(CDUnknownBlockType)arg5;
- (void)executeProductEngineRPC:(id)arg1 showLoading:(_Bool)arg2 callback:(CDUnknownBlockType)arg3;
- (void)executeRPCCallForTriggerByKeyParams:(id)arg1 module:(id)arg2 method:(id)arg3 jsonParam:(id)arg4 envData:(id)arg5 showLoading:(_Bool)arg6 bizRequestData:(id)arg7 callback:(CDUnknownBlockType)arg8;
