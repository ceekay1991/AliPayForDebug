...
#import "TFHomeATRollContentViewDelegate-Protocol.h"
#import "TFHomeAssistantTemplateProtocol-Protocol.h"

@class CCard, MFAttributeLabel, NSString, TFHomeATActionView, TFHomeATRollContentView, TFUglyClickChecker, UIButton, UIImageView;

@interface TFHomeAssistantTemplateThree : UIView <TFHomeATActionViewDelegate, TFHomeATRollContentViewDelegate, TFHomeAssistantTemplateProtocol>
{
    UIButton *_btnBg;
    ...
    TFHomeATRollContentView *_rollContentView;
    CCard *_card;
    TFUglyClickChecker *_clickChecker;
}

@property(retain, nonatomic) TFUglyClickChecker *clickChecker; // @synthesize clickChecker=_clickChecker;
@property(retain, nonatomic) CCard *card; // @synthesize card=_card;
@property(retain, nonatomic) TFHomeATRollContentView *rollContentView; // @synthesize rollContentView=_rollContentView;
...
- (void).cxx_destruct;
- (void)homeATRollContentViewClicked:(id)arg1;
