...
@class EhMessagePayloadModel, NSString;

@interface EhGetDisplayProductListResult : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasMessageModel; // @dynamic hasMessageModel;
...
@property(retain, nonatomic) EhMessagePayloadModel *messageModel; // @dynamic messageModel;
