...
@class NSArray, NSString, PBMapStringString, WEALTHFundAutoTransferInSetPB, WEALTHPasswordTokenCreatorPB;

@interface WEALTHFundAutoTransferInSetQueryResultPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSArray *contractItemList; // @dynamic contractItemList;
...
@property(retain, nonatomic) WEALTHFundAutoTransferInSetPB *fundAutoTransferInSet; // @dynamic fundAutoTransferInSet;
...
@property(readonly) _Bool hasFundAutoTransferInSet; // @dynamic hasFundAutoTransferInSet;
