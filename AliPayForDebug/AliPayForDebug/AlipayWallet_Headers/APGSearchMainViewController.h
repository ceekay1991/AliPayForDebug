...
@class APExceptionView, APGSearchBar, APGSearchCategoryNoFriendsView, APGSearchDetailViewController, APGSearchErrorView, APGSearchManager, APGSearchResultViewController, APGWKTableViewController, AUPopTipView, FBDocument, NSDictionary, NSMutableArray, NSOperationQueue, NSString, UIViewController;
...
@property(nonatomic) _Bool isFirstApear; // @synthesize isFirstApear=_isFirstApear;
...
@property(retain, nonatomic) UIViewController *suggestViewController; // @synthesize suggestViewController=_suggestViewController;
...
@property(retain, nonatomic) NSString *suggestionActionSrc; // @synthesize suggestionActionSrc=_suggestionActionSrc;
...
- (_Bool)openMainSuggest;
- (void)searchBar:(id)arg1 textDidChange:(id)arg2;
- (void)searchBarCancelButtonClicked:(id)arg1;
- (void)searchBarOpenVoiceAssister:(id)arg1;
- (_Bool)isNewSuggesVc;
- (_Bool)canIgnoreSearchButton;
- (void)searchSuggestWithText:(id)arg1;
- (void)searchSuggestWithText:(id)arg1 actionSrc:(id)arg2;
- (void)suggestWithText:(id)arg1;
- (void)searchText:(id)arg1;
- (void)showTipView:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)showTipViewIfNeed;
- (void)changeToPageIfNeed;
