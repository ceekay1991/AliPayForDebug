...
- (void).cxx_destruct;
- (void)promotionfeedBackWithSpaceCode:(id)arg1 objectId:(id)arg2 behavior:(id)arg3;
- (void)promotionDataDidFinishLoading:(id)arg1 spaceCode:(id)arg2;
- (void)promotionViewDidFinishLoading:(id)arg1 spaceCode:(id)arg2;
- (void)redPointPromotionShouldRefresh:(_Bool)arg1;
- (void)unregisterRedPointPromotion;
- (void)registerRedPointPromotion;
