...
#import "RVAOptionsProtocol-Protocol.h"

@class NSString, RVAViewControllerProxy;
...
@interface RVAOptions : NSObject <RVAOptionsProtocol>
{
    ...
    NSString *pushingURLString;
    RVAViewControllerProxy *viewControllerProxy;
}

@property(nonatomic) _Bool transparent; // @synthesize transparent;
@property(nonatomic) __weak RVAViewControllerProxy *viewControllerProxy; // @synthesize viewControllerProxy;
@property(copy, nonatomic) NSString *pushingURLString; // @synthesize pushingURLString;
