...
@class NSData, NSDate, NSError, NSString, NSURLRequest, NSURLResponse, NSURLSessionTask, NSURLSessionTaskMetrics, RVKResponse;

@interface RVKProxyEvent : RVKEvent
{
    ...
    RVKResponse *_customResponse;
    NSURLSessionTask *_task;
    NSURLSessionTaskMetrics *_metrics;
}

+ (id)requestCancelEvent:(id)arg1 error:(id)arg2 requestDate:(id)arg3 uniqueId:(id)arg4 channelId:(id)arg5;
+ (id)finishCollectingMetricsEvent:(id)arg1 request:(id)arg2 response:(id)arg3 task:(id)arg4 uniqueId:(id)arg5 channelId:(id)arg6;
...
@property(readonly, nonatomic) RVKResponse *customResponse; // @synthesize customResponse=_customResponse;
