...
@class NBDebugAppConfig, NBDebugAppManager, NBDebugAppPreferManager;

@interface NBDebugAppContext : NSObject
{
    NBDebugAppConfig *_appConfig;
    NBDebugAppManager *_appManager;
    NBDebugAppPreferManager *_appPreferManager;
}
...
+ (id)config;
+ (id)shared;
@property(retain, nonatomic) NBDebugAppPreferManager *appPreferManager; // @synthesize appPreferManager=_appPreferManager;
