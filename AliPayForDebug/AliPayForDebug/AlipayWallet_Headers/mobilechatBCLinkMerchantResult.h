...
@interface mobilechatBCLinkMerchantResult : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasTargetSchema; // @dynamic hasTargetSchema;
@property(retain, nonatomic) NSString *memo; // @dynamic memo;
@property(nonatomic) int resultStatus; // @dynamic resultStatus;
@property(retain, nonatomic) NSString *targetSchema; // @dynamic targetSchema;
