...
@class NSMutableData;
@protocol OS_dispatch_queue, WAudioInputQueueDelegate;

@interface WAudioInputQueue : NSObject
{
    _Bool _isRunning;
    _Bool _shouldResume;
    _Bool _started;
...
+ (id)inputQueueWithFormat:(struct AudioStreamBasicDescription)arg1 bufferSize:(unsigned int)arg2 delegate:(id)arg3 queue:(id)arg4;
...
- (void)dealloc;
- (id)initWithFormat:(struct AudioStreamBasicDescription)arg1 bufferSize:(unsigned int)arg2 delegate:(id)arg3 queue:(id)arg4;
