...
@class ALPProgressView, APChatMedia, APSnapChatTimerView, CTMessageCoverView, NSMutableArray, NSMutableDictionary, NSString, PKActivityIndicatorView, PKImageView, PKTextContainerView, UIButton, UIImageView, UILabel, UILongPressGestureRecognizer, UIMenuController, UITapGestureRecognizer, UIView;
...
@interface CTMessageCell : PKCell <UIGestureRecognizerDelegate, CTMessageCoverViewDelegate>
{
    ...
    PKTextContainerView *_editingView;
...
+ (id)menuTypesForDetailTextWithMessage:(id)arg1;
+ (id)menuTypesForEditingCellWithMessage:(id)arg1;
+ (id)menuTypesWithMessage:(id)arg1 matchTemplateId:(_Bool)arg2 isTranslation:(_Bool)arg3;
...
@property(retain, nonatomic) PKTextContainerView *editingView; // @synthesize editingView=_editingView;
...
- (void)showMenuForEditingModel:(id)arg1;
...
- (void)showPopMenus:(id)arg1 isTranslation:(_Bool)arg2;
- (void)showRefuseButton:(_Bool)arg1;
- (_Bool)supportRefuseTemplateId:(id)arg1;
