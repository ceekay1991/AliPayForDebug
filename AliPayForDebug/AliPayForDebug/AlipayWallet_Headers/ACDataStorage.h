...
@property(readonly, nonatomic) ACAppSystemSearchDelegate *systemSearchDelegate; // @synthesize systemSearchDelegate=_systemSearchDelegate;
...
- (void).cxx_destruct;
- (void)archiveUserValue:(id)arg1 forKey:(id)arg2;
- (void)saveUserValue:(id)arg1 forKey:(id)arg2;
...
- (void)cityChangeNotfiy:(id)arg1;
- (void)intlModelDidUpdated:(id)arg1;
