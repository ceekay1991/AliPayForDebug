...
@interface PBAppBaseInfo : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    ...
    NSMutableArray *_labelCodes;
    long long _lastTimestamp;
}

+ (id)parseFromData:(id)arg1;
@property(nonatomic) long long lastTimestamp; // @synthesize lastTimestamp=_lastTimestamp;
@property(retain, nonatomic) NSMutableArray *labelCodes; // @synthesize labelCodes=_labelCodes;
...
@property(readonly) _Bool hasLastTimestamp; // @synthesize hasLastTimestamp=_hasLastTimestamp;
@property(readonly) _Bool hasHistoryShow; // @synthesize hasHistoryShow=_hasHistoryShow;
...
- (void)addLabelCodes:(id)arg1;
- (void)setLabelCodesArray:(id)arg1;
- (int)serializedSize;
