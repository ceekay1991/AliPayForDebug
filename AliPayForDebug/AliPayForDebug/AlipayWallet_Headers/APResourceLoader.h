...
@protocol APResourceLoaderDelegate, OS_dispatch_queue;
...
@interface APResourceLoader : NSObject <APResourceLoaderTaskDelegate, AVAssetResourceLoaderDelegate>
{
    ...
    _Bool _audio;
    _Bool _canceled;
    _Bool _hasSyncDataReadingError;
...
@property(nonatomic) _Bool hasSyncDataReadingError; // @synthesize hasSyncDataReadingError=_hasSyncDataReadingError;
...
- (void)finishedLastEncryptResourceRequest:(id)arg1;
- (_Bool)isLastEncryptResourceRequest:(id)arg1;
- (void)reportDataReadingExceptionWithOffsest:(long long)arg1 length:(long long)arg2 returnDataLength:(id)arg3;
- (_Bool)canFinishLoadingRequest:(id)arg1;
