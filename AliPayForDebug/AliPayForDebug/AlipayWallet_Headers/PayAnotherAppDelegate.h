...
@class NSString, PARequestForPayViewController;

@interface PayAnotherAppDelegate : NSObject <DTMicroApplicationDelegate>
{
    PARequestForPayViewController *_rootController;
}

@property(retain, nonatomic) PARequestForPayViewController *rootController; // @synthesize rootController=_rootController;
- (void).cxx_destruct;
