...
@class GWRouter, NSDictionary, NSString;

@interface GoldWordAppDelegate : NSObject <DTMicroApplicationDelegate>
{
    NSDictionary *_startOptions;
    GWRouter *_router;
}

@property(retain, nonatomic) GWRouter *router; // @synthesize router=_router;
