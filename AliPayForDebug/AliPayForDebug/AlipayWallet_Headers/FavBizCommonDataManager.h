...
#import "FavBizDataManagerProtocol-Protocol.h"

@class FavCommonDataManager, NSString;
@protocol FavBizDataManagerDelegate, OS_dispatch_queue;
...
- (void)syncData;
- (id)queryFavItems;
- (id)queryFavItemsInFilterTypes:(id)arg1;
