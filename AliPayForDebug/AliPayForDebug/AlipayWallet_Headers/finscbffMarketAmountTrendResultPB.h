...
@class NSString, finscbffMarketAmountTrendDataPB;

@interface finscbffMarketAmountTrendResultPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasTrendData; // @dynamic hasTrendData;
...
@property(retain, nonatomic) finscbffMarketAmountTrendDataPB *trendData; // @dynamic trendData;
