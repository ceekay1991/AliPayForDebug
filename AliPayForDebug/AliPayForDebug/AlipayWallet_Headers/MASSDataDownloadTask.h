...
@property(nonatomic) long long md5RetryTime; // @synthesize md5RetryTime=_md5RetryTime;
...
@property(retain, nonatomic) NSString *expectedMD5; // @synthesize expectedMD5=_expectedMD5;
