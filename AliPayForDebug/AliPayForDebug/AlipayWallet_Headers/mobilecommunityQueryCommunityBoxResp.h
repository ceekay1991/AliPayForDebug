...
@interface mobilecommunityQueryCommunityBoxResp : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSArray *boxHeaderModels; // @dynamic boxHeaderModels;
...
@property(readonly) _Bool hasCurrentTimestamp; // @dynamic hasCurrentTimestamp;
