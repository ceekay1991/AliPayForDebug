...
@class NSString, mobilerelationFriendTabItemBrief;

@interface mobilerelationFriendTabItemResult : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) mobilerelationFriendTabItemBrief *itemBrief; // @dynamic itemBrief;
