...
@class APAEventDispatcher, APBirdNestJSInvoke, APBirdNestJSPropGet, APBirdNestJSPropSet, NSMutableArray, NSMutableDictionary, NSString, UIViewController;
...
+ (_Bool)needRollback:(id)arg1 withRemote:(id)arg2;
+ (_Bool)needFetchFromServer:(id)arg1 withRemote:(id)arg2;
+ (void)onPreDownloadResAvailable:(id)arg1;
...
- (id)docWithData:(id)arg1 templateId:(id)arg2 delegate:(id)arg3 completionBlock:(CDUnknownBlockType)arg4 measureOnly:(_Bool)arg5;
- (id)docWithData:(id)arg1 templateId:(id)arg2 delegate:(id)arg3 completionBlock:(CDUnknownBlockType)arg4;
- (id)docWithData:(id)arg1 templateId:(id)arg2 completionBlock:(CDUnknownBlockType)arg3 measureOnly:(_Bool)arg4;
