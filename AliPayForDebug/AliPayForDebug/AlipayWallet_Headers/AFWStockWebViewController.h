...
#import "AFWCarouselViewDelegate-Protocol.h"
#import "AFWStockCacheProtocol-Protocol.h"
#import "AFWStockWebCoreDelegate-Protocol.h"
#import "DTCustomNavigationBarProtocol-Protocol.h"
#import "UIScrollViewDelegate-Protocol.h"

@class AFWCarouselView, AFWSH5NumberKeyboard, AFWStockLoadRecord, AFWStockNaviTitleView, AFWStockOptions, AFWStockWebCore, AFWStockWebNavigationItem, AFWStockWebProgressView, NSDictionary, NSMutableDictionary, NSString;

@interface AFWStockWebViewController : DTViewController <UIScrollViewDelegate, DTCustomNavigationBarProtocol, AFWStockWebCoreDelegate, AFWCarouselViewDelegate, AFWStockCacheProtocol>
{
    ...
    int _uniqueId;
    AFWStockOptions *_options;
    NSDictionary *_reportDataSpmDict;
    AFWCarouselView *_carouselView;
    AFWSH5NumberKeyboard *_numberKeyboard;
    NSString *_url;
    AFWStockNaviTitleView *_titleView;
    AFWStockWebProgressView *_progressView;
    AFWStockWebNavigationItem *_jsapiNavItem;
    AFWStockWebCore *_webCore;
    NSMutableDictionary *_cacheDict;
    double _paddingBottom;
    double _webviewOriginY;
    AFWStockLoadRecord *_timeRecord;
    struct CGPoint _originContentOffset;
}

@property(retain, nonatomic) AFWStockLoadRecord *timeRecord; // @synthesize timeRecord=_timeRecord;
...
@property(retain, nonatomic) AFWStockWebCore *webCore; // @synthesize webCore=_webCore;
@property(retain, nonatomic) AFWStockWebNavigationItem *jsapiNavItem; // @synthesize jsapiNavItem=_jsapiNavItem;
@property(retain, nonatomic) AFWStockWebProgressView *progressView; // @synthesize progressView=_progressView;
@property(retain, nonatomic) AFWStockNaviTitleView *titleView; // @synthesize titleView=_titleView;
@property(copy, nonatomic) NSString *url; // @synthesize url=_url;
@property(retain, nonatomic) AFWSH5NumberKeyboard *numberKeyboard; // @synthesize numberKeyboard=_numberKeyboard;
@property(retain, nonatomic) AFWCarouselView *carouselView; // @synthesize carouselView=_carouselView;
@property(retain, nonatomic) NSDictionary *reportDataSpmDict; // @synthesize reportDataSpmDict=_reportDataSpmDict;
@property(retain, nonatomic) AFWStockOptions *options; // @synthesize options=_options;
- (void).cxx_destruct;
- (void)gotoTarget:(id)arg1;
- (void)cancelNoticeboard;
- (void)showCarcousel:(id)arg1 actionUrl:(id)arg2 closeCallback:(CDUnknownBlockType)arg3 jumpCallback:(CDUnknownBlockType)arg4;
