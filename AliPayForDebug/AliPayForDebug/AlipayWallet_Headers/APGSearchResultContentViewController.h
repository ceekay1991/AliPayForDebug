...
@class APGSearchDetailViewController, APGSearchErrorView, APGSearchManager, APGSearchResultViewController, APGTabConfig, APGWKTableViewController, AUNetErrorView, NSDictionary, NSMutableArray, NSMutableDictionary, NSOperationQueue, NSString, WKTableCellModel;
...
- (void)searchResultItemClickMonitor:(id)arg1 index:(long long)arg2 groupKey:(id)arg3 sectionIndex:(long long)arg4;
