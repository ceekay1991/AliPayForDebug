...
@class NSString, kbscprodAddressFilterPage;

@interface kbscprodAddressFilterResponse : NSObject
{
    _Bool _success;
    NSString *_errorCode;
    NSString *_errorMsg;
    NSString *_errorName;
    NSString *_tip;
    kbscprodAddressFilterPage *_addressFilterPage;
}

@property(retain, nonatomic) kbscprodAddressFilterPage *addressFilterPage; // @synthesize addressFilterPage=_addressFilterPage;
