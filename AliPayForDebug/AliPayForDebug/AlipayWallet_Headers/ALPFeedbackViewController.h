...
#import "AUCheckBoxListItemDelegate-Protocol.h"
...
@class AUButton, AUInputBox, AUParagraphInputBox, FeedbackGuessQuestionView, MessagePhotoView, NSArray, NSMutableArray, NSString, UIImage, UIScrollView, UITableView;
@protocol ALPFeedbackEventDelegate, SAAccountService;
...
@interface ALPFeedbackViewController : DTViewController <AUDialogDelegate, UIGestureRecognizerDelegate, UITableViewDelegate, UITableViewDataSource, AUCheckBoxListItemDelegate, UITextViewDelegate>
{
    ...
    FeedbackGuessQuestionView *_guessQuestionView;
    AUButton *_submitButton;
    NSString *_lastQueryWords;
    NSString *_questionSessionId;
}

@property(nonatomic) float questionRpcTimeOut; // @synthesize questionRpcTimeOut=_questionRpcTimeOut;
@property(nonatomic) _Bool questionSwitch; // @synthesize questionSwitch=_questionSwitch;
@property(copy, nonatomic) NSString *questionSessionId; // @synthesize questionSessionId=_questionSessionId;
@property(copy, nonatomic) NSString *lastQueryWords; // @synthesize lastQueryWords=_lastQueryWords;
@property(retain, nonatomic) AUButton *submitButton; // @synthesize submitButton=_submitButton;
@property(retain, nonatomic) FeedbackGuessQuestionView *guessQuestionView; // @synthesize guessQuestionView=_guessQuestionView;
...
- (void)animateGuessQuestionArea;
- (void)querySuggestQuestion:(id)arg1;
- (void)updateSuggestQuestions:(id)arg1;
- (void)getFeedbackSessionId;
- (void)back;
- (_Bool)isLoginStatus;
- (void)createSubViews;
- (void)viewDidLoad;
