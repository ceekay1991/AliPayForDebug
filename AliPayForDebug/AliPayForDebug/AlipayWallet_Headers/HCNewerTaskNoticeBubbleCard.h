...
@class MFAttributeLabel, UIView;

@interface HCNewerTaskNoticeBubbleCard : CCWidgetView
{
    UIView *_shadowCard;
...
@property(retain, nonatomic) UIView *shadowCard; // @synthesize shadowCard=_shadowCard;
- (void).cxx_destruct;
