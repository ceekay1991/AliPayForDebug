...
@class NSString, SocialRemindListViewController;

@interface SocialRemindAppDelegate : NSObject <DTMicroApplicationDelegate>
{
    SocialRemindListViewController *_rootController;
}

@property(retain, nonatomic) SocialRemindListViewController *rootController; // @synthesize rootController=_rootController;
- (void).cxx_destruct;
