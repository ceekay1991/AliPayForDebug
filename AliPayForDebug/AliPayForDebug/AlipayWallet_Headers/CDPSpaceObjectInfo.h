...
@interface CDPSpaceObjectInfo : NSObject <NSCoding>
{
    ...
    NSDictionary *_logExtInfo;
    NSString *_spaceCode;
    UIImageView *_iconImageView;
    double _bgColorOpacity;
    NSDictionary *_cdpExtInfo;
    NSDictionary *_spaceExtInfo;
    NSString *_pageToken;
    NSString *_alixSampleId;
}

+ (Class)logExtInfoElementClass;
+ (Class)crontabListElementClass;
+ (Class)resourceInfosElementClass;
+ (Class)bizExtInfoElementClass;
+ (Class)behaviorsElementClass;
@property(retain, nonatomic) NSString *alixSampleId; // @synthesize alixSampleId=_alixSampleId;
@property(retain, nonatomic) NSString *pageToken; // @synthesize pageToken=_pageToken;
@property(retain, nonatomic) NSDictionary *spaceExtInfo; // @synthesize spaceExtInfo=_spaceExtInfo;
...
@property(retain, nonatomic) NSDictionary *logExtInfo; // @synthesize logExtInfo=_logExtInfo;
