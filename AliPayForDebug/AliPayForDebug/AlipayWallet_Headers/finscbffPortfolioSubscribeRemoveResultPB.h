...
@interface finscbffPortfolioSubscribeRemoveResultPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasRemoveSuccess; // @dynamic hasRemoveSuccess;
...
@property(nonatomic) _Bool removeSuccess; // @dynamic removeSuccess;
