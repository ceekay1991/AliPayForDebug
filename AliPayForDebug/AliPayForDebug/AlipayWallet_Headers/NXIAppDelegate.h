...
@class NSNumber, NSString, NXAAppSession, NXISession, UIViewController;

@interface NXIAppDelegate : NSObject <H5ServiceDelegate, PSDPluginProtocol, DTMicroApplicationDelegate>
{
    ...
    NXISession *_nxiSession;
}

@property(retain, nonatomic) NXISession *nxiSession; // @synthesize nxiSession=_nxiSession;
...
@property(retain, nonatomic) NXAAppSession *app; // @synthesize app=_app;
