...
@interface finscbffPlateDescResultPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasPlateDesc; // @dynamic hasPlateDesc;
...
@property(retain, nonatomic) NSString *plateDesc; // @dynamic plateDesc;
