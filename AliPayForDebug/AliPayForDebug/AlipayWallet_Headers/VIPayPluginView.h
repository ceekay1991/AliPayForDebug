...
- (void)viHandleOtherPayWayWithValue:(id)arg1;
...
- (void)removePwdInputView;
- (_Bool)isCashierSupportRetain;
- (_Bool)isCashierUsePwdBtnShow;
- (_Bool)isUsePwdForPlus;
- (_Bool)isCashierSupportNewUI;
- (void)viStartWithValue:(id)arg1;
- (void)updateRect;
- (void)viRpcResponseWithValue:(id)arg1;
- (void)viClosePageWithValue:(id)arg1;
- (void)dealloc;
- (void)viPreloadWithValue:(id)arg1;
