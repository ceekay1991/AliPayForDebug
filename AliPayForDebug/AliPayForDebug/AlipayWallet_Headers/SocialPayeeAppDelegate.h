...
@interface SocialPayeeAppDelegate : NSObject <DTMicroApplicationDelegate>
{
...
- (void)_managerViewControllerIsAdmin:(_Bool)arg1 batchId:(id)arg2 listType:(int)arg3;
- (id)_prepareFundsTransferViewControllerWithGroupId:(id)arg1;
- (id)_prepareContactViewController;
