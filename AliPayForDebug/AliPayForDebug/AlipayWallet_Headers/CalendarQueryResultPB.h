...
@interface CalendarQueryResultPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSArray *billDates; // @dynamic billDates;
@property(retain, nonatomic) NSArray *dateContents; // @dynamic dateContents;
...
@property(retain, nonatomic) NSArray *redPoints; // @dynamic redPoints;
