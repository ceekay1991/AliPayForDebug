...
#import "RVANavigationTitleViewProtocol-Protocol.h"
...
@interface RVANavigationTitleView : UIView <RVANavigationTitleViewProtocol>
{
    ...
    _Bool _isAnimating;
    id <RVANavigationTitleViewDelegate> _delegate;
...
@property(nonatomic) __weak id <RVANavigationTitleViewDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
