...
@interface minicenterMiniAppRelationCheckResultPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasJumpable; // @dynamic hasJumpable;
...
@property(nonatomic) _Bool jumpable; // @dynamic jumpable;
