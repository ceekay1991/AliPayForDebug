...
@interface pushcoreBindUserReqPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasIsPush; // @dynamic hasIsPush;
...
@property(readonly) _Bool hasVoipToken; // @dynamic hasVoipToken;
@property(retain, nonatomic) NSString *isPush; // @dynamic isPush;
...
@property(retain, nonatomic) NSString *voipToken; // @dynamic voipToken;
