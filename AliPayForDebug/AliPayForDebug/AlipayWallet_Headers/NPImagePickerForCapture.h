...
@interface NPImagePickerForCapture : NSObject <BEEPhotoPickerDelegate, UIImagePickerControllerDelegate>
{
    _Bool _returnPixelSize;
    _Bool _allowEdit;
    ...
    unsigned long long _forceSizeType;
}

@property(nonatomic) _Bool selectStyleAlways; // @synthesize selectStyleAlways=_selectStyleAlways;
@property(nonatomic) unsigned long long forceSizeType; // @synthesize forceSizeType=_forceSizeType;
...
@property(nonatomic) _Bool returnPixelSize; // @synthesize returnPixelSize=_returnPixelSize;
...
- (void)translateAssets:(id)arg1 original:(_Bool)arg2;
