...
@protocol FHWealthBenchManagerDelegate;

@interface FHWealthBenchManager : NSObject <ALTCardContainerDelegate>
{
    id <FHWealthBenchManagerDelegate> _delegate;
    NSString *_obFloor;
    NSString *_spmPrefix;
...
@property(nonatomic) __weak id <FHWealthBenchManagerDelegate> delegate; // @synthesize delegate=_delegate;
- (void).cxx_destruct;
