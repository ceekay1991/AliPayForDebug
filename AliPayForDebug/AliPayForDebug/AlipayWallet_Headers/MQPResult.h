...
@property(nonatomic) _Bool thirdPrompt; // @synthesize thirdPrompt=_thirdPrompt;
@property(nonatomic) _Bool checkThirdPage; // @synthesize checkThirdPage=_checkThirdPage;
