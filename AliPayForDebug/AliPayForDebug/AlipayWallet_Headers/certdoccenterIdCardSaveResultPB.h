...
@interface certdoccenterIdCardSaveResultPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSString *certDocId; // @dynamic certDocId;
@property(readonly) _Bool hasCertDocId; // @dynamic hasCertDocId;
