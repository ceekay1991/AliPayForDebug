...
@class NSLock, NSMutableArray, NSMutableAttributedString, NSString, UIColor, UIFont, VRLabelURL;
@protocol VRRichLabelDelegate;
...
@property(retain, nonatomic) NSLock *frameLock; // @synthesize frameLock=_frameLock;
