...
#import "TFMatchMobileListViewDelegate-Protocol.h"
...
@class APContactInfo, APContactLocalSearchManager, AUInputBox, NSString, TFAccountPasteComponent, TFMatchMobileListView, TFPasteTipView, TFReciverInfoChecker, TFTransferRequest, UIActivityIndicatorView, UIButton, UITableView, UITextField;

@interface TFTransfer2AccountController : DTViewController <UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate, UIActionSheetDelegate, APContactViewControllerDelegate, TFMatchMobileListViewDelegate, TFTransferFormProtocol>
{
    _Bool m_hasAutoSubmited;
    _Bool tfc_contactSelectRollback;
    _Bool tfc_transferCardSelectionSwitch;
    _Bool _isKeyboardVisible;
    _Bool _contactOverlap;
    _Bool _showPasteTip;
    _Bool _filterMailSuffix;
    ...
    NSString *_delay;
    NSString *_transferToAccountRemark;
}

@property(copy, nonatomic) NSString *transferToAccountRemark; // @synthesize transferToAccountRemark=_transferToAccountRemark;
@property(nonatomic) _Bool filterMailSuffix; // @synthesize filterMailSuffix=_filterMailSuffix;
...
- (void)rightBarBtnItemTouchHandler;
