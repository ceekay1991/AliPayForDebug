...
@property(readonly) _Bool hasMobilePhone; // @dynamic hasMobilePhone;
@property(readonly) _Bool hasPreinstallMark; // @dynamic hasPreinstallMark;
...
@property(retain, nonatomic) NSString *preinstallMark; // @dynamic preinstallMark;
