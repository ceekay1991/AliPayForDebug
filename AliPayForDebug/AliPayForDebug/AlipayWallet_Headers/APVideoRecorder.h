...
#import "APBeautyManagerDelegate-Protocol.h"
...
#import "RecorderLightDarkViewDelegate-Protocol.h"

@class APBeautyManager, APMLoadingView, APMLock, APMRecorderFocusView, APMTextureView, APMVideoPreviewViewContainer, APMVideoWriter, APVideoExportSetting, APVideoRemoteInfo, AVCaptureAudioDataOutput, AVCaptureConnection, AVCaptureDeviceInput, AVCaptureSession, AVCaptureStillImageOutput, AVCaptureVideoDataOutput, AVCaptureVideoPreviewLayer, CLLocation, CLLocationManager, EAGLContext, NSDate, NSMutableDictionary, NSObject, NSString, NSTimer, RecorderLightDarkView, UIImage, UILabel;
@protocol APVideoRecorderDelegate, OS_dispatch_queue;

@interface APVideoRecorder : UIView <AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate, APMVideoWriterDelegate, APAudioSessionManagerDelegate, RecorderLightDarkViewDelegate, APBeautyManagerDelegate, CLLocationManagerDelegate, APMDeviceOrientationMonitorDelegate>
{
...
@property(nonatomic) _Bool useSystemVideoPreview; // @synthesize useSystemVideoPreview=_useSystemVideoPreview;
...
- (void)requestCameraPermissionForMode:(unsigned long long)arg1 completion:(CDUnknownBlockType)arg2;
