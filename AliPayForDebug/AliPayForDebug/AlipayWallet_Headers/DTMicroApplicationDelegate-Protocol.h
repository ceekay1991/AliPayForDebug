...
@class DTMicroApplication, NSArray, NSDictionary, NSString, UINavigationController, UIViewController;
...
- (NSArray *)delayReleaseApplicationControllers:(NSArray *)arg1 params:(NSDictionary *)arg2;
- (NSArray *)delayReleaseApplicationControllers:(NSArray *)arg1;
...
- (_Bool)applicationShouldStopPresent:(DTMicroApplication *)arg1 params:(NSDictionary *)arg2 navigationController:(UINavigationController *)arg3;
