...
- (id)switchIcon:(long long)arg1;
- (void)showToastWithImage:(id)arg1 text:(id)arg2 action:(id)arg3 delay:(double)arg4;
- (void)showToastWithIcon:(int)arg1 text:(id)arg2 bShow:(_Bool)arg3;
- (void)showLoadViewWithText:(id)arg1 bShow:(_Bool)arg2 onView:(id)arg3;
