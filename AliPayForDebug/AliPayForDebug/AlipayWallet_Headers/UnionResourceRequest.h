...
@property(retain, nonatomic) NSString *clientPosition; // @dynamic clientPosition;
...
@property(readonly) _Bool hasClientPosition; // @dynamic hasClientPosition;
...
@property(readonly) _Bool hasRom; // @dynamic hasRom;
@property(readonly) _Bool hasStartTiming; // @dynamic hasStartTiming;
...
@property(nonatomic) int startTiming; // @dynamic startTiming;
