...
@interface GSBioLockscreenViewController : GSViewController
{
...
- (void)remoteLoggerBGBtn:(unsigned long long)arg1;
- (void)remoteLoggerBGshow:(unsigned long long)arg1;
- (void)remoteLoggerPass;
- (void)remoteLoggerCancel;
- (void)remoteLoggerLoginWithPwd;
- (void)remoteLoggerTouchIDShow:(int)arg1;
