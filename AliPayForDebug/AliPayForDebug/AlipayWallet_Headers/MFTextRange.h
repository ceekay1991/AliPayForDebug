...
@class MFTextPosition;

@interface MFTextRange : UITextRange <NSCopying>
{
    MFTextPosition *_start;
    MFTextPosition *_end;
}
...
@property(readonly, nonatomic) MFTextPosition *end;
@property(readonly, nonatomic) MFTextPosition *start;
- (id)init;
