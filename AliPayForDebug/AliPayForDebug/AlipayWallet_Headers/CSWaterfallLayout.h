...
@protocol CSCollectionViewDelegateWaterfallLayout;

@interface CSWaterfallLayout : UICollectionViewLayout
{
    ...
    id <CSCollectionViewDelegateWaterfallLayout> _delegate;
...
@property(nonatomic) __weak id <CSCollectionViewDelegateWaterfallLayout> delegate; // @synthesize delegate=_delegate;
