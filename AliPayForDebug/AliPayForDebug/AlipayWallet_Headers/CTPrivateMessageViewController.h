...
#import "APSocialTipsViewDelegate-Protocol.h"
...
@class ABUnknownPersonViewController, APBarButtonItem, APChatLocalSearchManager, APChatRoomSetTagViewController, APChatRoomSimpleProfileController, APContactInfo, APSocialNoticeDisplayView, APSocialPeekPop, APSocialTipsModel, APSocialTipsView, AUImageDialog, CTCoverAlertView, CTLoadingHeadView, CTTitleView, DTRpcAsyncCaller, MFMailComposeViewController, NSArray, NSMutableArray, NSMutableDictionary, NSOperationQueue, NSString, NSTimer, PKChatSnapVideoShowView, PKSnapChatImageView, PKSnapChatVideoWidget, PKStatusBar, PKVoiceToWordView, UIActivityIndicatorView, UIButton, UITextField, UIView, UIWindow;
@protocol APSocialPreviewingProtocol;

@interface CTPrivateMessageViewController : CTAutoVoicePlayViewController <UIScrollViewDelegate, UIActionSheetDelegate, UINavigationControllerDelegate, AUDialogDelegate, MFMailComposeViewControllerDelegate, CTMessageCellUserNameDelegate, CTMessageCellEditModeDelegate, PKStatusBarDelegate, APSearchBarDelegate, CTMessageDetailViewDelegate, CTMessageCellDelegate, ABPeoplePickerNavigationControllerDelegate, ABNewPersonViewControllerDelegate, PKChatSnapVideoShowViewDelegate, PKSnapChatVideoWidgetDelegate, CNContactViewControllerDelegate, CNContactPickerDelegate, BEEPhotoBrowserDelegate, APSocialTipsViewDelegate, APSocialPreviewedProtocol>
{
    _Bool _isScorlling;
...
- (void)sendSystemMessageWithString:(id)arg1;
- (void)sendMockMessageForPrivateMessage;
...
- (void)socialTipsActionClickRespond:(id)arg1 actionJumUrl:(id)arg2;
