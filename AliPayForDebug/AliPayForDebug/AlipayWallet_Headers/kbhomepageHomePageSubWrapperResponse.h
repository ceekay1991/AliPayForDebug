...
@class MOBILECSADynamicBlockReponse, NSString;

@interface kbhomepageHomePageSubWrapperResponse : kbhomepageToString
{
    _Bool _success;
    MOBILECSADynamicBlockReponse *_data;
    NSString *_scene;
    NSString *_errorCode;
    NSString *_errorMsg;
}
...
@property(retain, nonatomic) MOBILECSADynamicBlockReponse *data; // @synthesize data=_data;
- (void).cxx_destruct;
