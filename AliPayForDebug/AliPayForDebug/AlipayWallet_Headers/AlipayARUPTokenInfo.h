...
@class AlipayARUPOrigin, NSMutableArray, NSString;

@interface AlipayARUPTokenInfo : NSObject
{
...
@property(retain, nonatomic) AlipayARUPOrigin *origin; // @synthesize origin=_origin;
