...
@class NSString, XRTCVideoCodecInfo;

@interface XRTCVideoEncoderH264 : NSObject <XRTCVideoEncoder>
{
    XRTCVideoCodecInfo *_codecInfo;
    struct unique_ptr<xwebrtc::BitrateAdjuster, std::__1::default_delete<xwebrtc::BitrateAdjuster>> _bitrateAdjuster;
    ...
    optional_634d75e6 _profile_level_id;
    ...
    int _numOfMalfunctionErrs;
    int _retryNumOfMalfunctionErrs;
}
