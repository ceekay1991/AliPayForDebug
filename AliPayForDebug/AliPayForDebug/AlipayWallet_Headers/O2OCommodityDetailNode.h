...
+ (id)itemWithInfo:(id)arg1 index:(int)arg2 store:(id)arg3 passId:(id)arg4;
+ (id)separatorLine;
+ (id)infoForDetail:(id)arg1 Store:(id)arg2 infoChildren:(vector_994f9055)arg3;
...
+ (id)wishInfoNodeForDetail:(id)arg1;
