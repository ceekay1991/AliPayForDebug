...
@class NSMutableArray, NSMutableDictionary, NSString, O2OLocationCityInfo;
@protocol OS_dispatch_queue;

@interface O2OCommonCDPAdapter : NSObject <PromotionCenterDelegate>
{
    NSObject<OS_dispatch_queue> *_promotionQueue;
    O2OLocationCityInfo *_locationCityInfo;
    NSMutableDictionary *_promotionObservers;
    NSMutableDictionary *_promotinCacheDatas;
    NSMutableDictionary *_channelPromotionForSpaceCodes;
    NSMutableArray *_channelSpaceCodes;
}
...
+ (void)loadCDP:(id)arg1;
+ (id)sharedInstance;
@property(retain, nonatomic) NSMutableArray *channelSpaceCodes; // @synthesize channelSpaceCodes=_channelSpaceCodes;
@property(retain, nonatomic) NSMutableDictionary *channelPromotionForSpaceCodes; // @synthesize channelPromotionForSpaceCodes=_channelPromotionForSpaceCodes;
...
@property(retain, nonatomic) O2OLocationCityInfo *locationCityInfo; // @synthesize locationCityInfo=_locationCityInfo;
@property(retain, nonatomic) NSObject<OS_dispatch_queue> *promotionQueue; // @synthesize promotionQueue=_promotionQueue;
- (void).cxx_destruct;
- (id)generateExtInfo:(id)arg1;
...
- (id)findPromotionByChannelSpaceCode:(id)arg1;
- (void)handleChannelSpaceInfo:(id)arg1 spaceCode:(id)arg2 observer:(id)arg3;
- (void)getChannelSpaceInfosWithObserver:(id)arg1 spaceCodes:(id)arg2 extInfo:(id)arg3;
- (void)getChannelSpaceInfoWithObserver:(id)arg1 spaceCode:(id)arg2 extInfo:(id)arg3;
- (id)init;
