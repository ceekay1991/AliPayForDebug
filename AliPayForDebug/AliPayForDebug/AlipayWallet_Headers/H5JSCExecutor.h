...
- (void).cxx_destruct;
- (void)callbackWithJSCAPI:(id)arg1 data:(id)arg2 dataKey:(id)arg3 extraInfo:(id)arg4;
- (id)currentJSContext;
...
- (void)executeSyncApplicationScript:(id)arg1 sourceURL:(id)arg2 onComplete:(CDUnknownBlockType)arg3 sourceFromDispatchError:(_Bool)arg4;
