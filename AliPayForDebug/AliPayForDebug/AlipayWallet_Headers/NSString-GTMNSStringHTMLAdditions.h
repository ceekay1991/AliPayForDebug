...
- (id)gtm_stringByUnescapingFromHTML_ap;
- (id)gtm_stringByEscapingForAsciiHTML_ap;
- (id)gtm_stringByEscapingForHTML_ap;
- (id)gtm_stringByEscapingHTMLUsingTable_ap:(CDStruct_6a59ab51 *)arg1 ofSize:(unsigned long long)arg2 escapingUnicode:(_Bool)arg3;
@end
