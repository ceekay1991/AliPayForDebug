...
@class NSArray, NSString, mobilecodecPreShareTemplateInfoPB;

@interface mobilecodecPreShareResultPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) mobilecodecPreShareTemplateInfoPB *templateInfo; // @dynamic templateInfo;
