...
#import "NBNetDownloadConnectDelegate-Protocol.h"

@class FlowStatisticInfo, NBNetDownloadConnect, NSData, NSDictionary, NSMutableData, NSMutableDictionary, NSOutputStream, NSString, NSTimer;
@protocol NBNetDownloadTaskDelegate;
...
@property(retain) FlowStatisticInfo *flowStatis; // @synthesize flowStatis=_flowStatis;
@property(retain, nonatomic) NSString *serverVIA; // @synthesize serverVIA=_serverVIA;
