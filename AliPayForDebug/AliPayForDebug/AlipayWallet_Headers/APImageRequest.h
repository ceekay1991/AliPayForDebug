...
+ (id)stringWithHEVCWithBizType:(id)arg1;
+ (id)stringWithHEIC;
+ (id)stringWithWebp;
...
@property(nonatomic) _Bool useSourceType; // @synthesize useSourceType=_useSourceType;
...
- (_Bool)canDecodeHevc;
- (id)dynamicFormat;
- (id)optimzedOriginalZoomStr;
- (id)optimzedSizeZoomStr:(id)arg1;
...
- (id)dynamicFormatParameterWithMobileNetwork:(_Bool)arg1 grayUser:(_Bool)arg2 enablePJPEG:(_Bool)arg3;
- (id)aftsCdnDynamicFormatZoomStringWithSize:(struct CGSize)arg1 mobileNetwork:(_Bool)arg2 grayUser:(_Bool)arg3 enablePJPEG:(_Bool)arg4;
