...
@class ImmPayAccountView, ImmPaySettingService, ImmPayWindows, MMPNavigation, MMPToastView, MQPBaseService, NSMutableArray, NSString, UIView, UIWindow;
...
@interface ImmPayViewHandler : NSObject <MMPNavigationDelegate>
{
    ...
    MMPNavigation *_navigation;
}

@property(retain, nonatomic) MMPNavigation *navigation; // @synthesize navigation=_navigation;
...
- (void).cxx_destruct;
- (_Bool)windowIsAvailable:(id)arg1;
- (void)navigation:(id)arg1 didPopViewControllers:(id)arg2;
...
- (void)closeAllWithAnimation:(_Bool)arg1;
