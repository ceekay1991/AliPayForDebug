...
@class APBRegionPB, NSArray, NSData, NSString, PBMapStringString;

@interface APBPapersUploadGwContentPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) APBRegionPB *faceRegion; // @dynamic faceRegion;
...
@property(readonly) _Bool hasImgUrlType; // @dynamic hasImgUrlType;
...
@property(retain, nonatomic) NSString *imgUrlType; // @dynamic imgUrlType;
@property(retain, nonatomic) NSString *lastModifiedTime; // @dynamic lastModifiedTime;
@property(retain, nonatomic) NSArray *monitorImgs; // @dynamic monitorImgs;
@property(nonatomic) int pageNo; // @dynamic pageNo;
@property(retain, nonatomic) APBRegionPB *papersRegion; // @dynamic papersRegion;
