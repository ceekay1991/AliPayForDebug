...
@class CADisplayLink, MFSwipeButtonsView, MGSwipeAnimationData, MGSwipeExpansionSettings, MGSwipeSettings, MGSwipeTableInputOverlay, NSArray, NSMutableSet, UIColor, UIImageView, UIPanGestureRecognizer, UITapGestureRecognizer, UIView;
@protocol MFSwipeTableCellDelegate;

@interface MFSwipeTableCell : MFCell
{
    ...
    MFSwipeButtonsView *_leftView;
    MFSwipeButtonsView *_rightView;
    _Bool _allowSwipeRightToLeft;
    _Bool _allowSwipeLeftToRight;
    MFSwipeButtonsView *_activeExpansion;
    ...
    id <MFSwipeTableCellDelegate> _swipeDelegate;
...
@property(nonatomic) __weak id <MFSwipeTableCellDelegate> swipeDelegate; // @synthesize swipeDelegate=_swipeDelegate;
- (void).cxx_destruct;
