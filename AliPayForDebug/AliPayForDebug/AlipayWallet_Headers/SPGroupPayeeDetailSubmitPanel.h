...
@class APCheckBox, AUButton, AUInputBox, NSString, SPFundChannelManager, SPGTSubmitButton, SPGroupPayeeDetailViewModel, UIButton, UILabel;
...
+ (_Bool)shouldFixWrongSafeAreaBottom;
...
@property(retain, nonatomic) AUButton *scanShareBtn; // @synthesize scanShareBtn=_scanShareBtn;
...
@property(retain, nonatomic) AUInputBox *payAmountBox; // @synthesize payAmountBox=_payAmountBox;
