...
@property(readonly, nonatomic) unsigned int LOT_rgbHex;
@property(readonly, nonatomic) double LOT_alpha;
@property(readonly, nonatomic) double LOT_white;
@property(readonly, nonatomic) double LOT_blue;
@property(readonly, nonatomic) double LOT_green;
@property(readonly, nonatomic) double LOT_red;
- (_Bool)LOT_red:(double *)arg1 green:(double *)arg2 blue:(double *)arg3 alpha:(double *)arg4;
- (id)LOT_arrayFromRGBAComponents;
@property(readonly, nonatomic) _Bool LOT_canProvideRGBComponents;
- (id)LOT_colorSpaceString;
@property(readonly, nonatomic) int LOT_colorSpaceModel;
@end
