...
- (void)unbindDeviceTokenWithUserID:(NSString *)arg1 productId:(NSString *)arg2 token:(NSString *)arg3 success:(void (^)(NSString *))arg4 failed:(void (^)(NSString *))arg5;
- (void)bindDeviceTokenWithUserID:(NSString *)arg1 productId:(NSString *)arg2 token:(NSString *)arg3 success:(void (^)(NSString *))arg4 failed:(void (^)(NSString *))arg5;
