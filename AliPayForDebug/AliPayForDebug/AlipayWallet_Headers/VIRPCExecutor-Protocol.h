...
- (void)executeRPCCallForTriggerByKeyParams:(NSDictionary *)arg1 module:(NSString *)arg2 method:(NSString *)arg3 jsonParam:(NSString *)arg4 envData:(NSString *)arg5 showLoading:(_Bool)arg6 bizRequestData:(NSString *)arg7 callback:(void (^)(VIRPCResponse *))arg8;
