...
@class NSString, RVKKernel;

@interface NXKPluginBase : NSObject <RVKPluginProtocol>
{
...
@property(readonly, nonatomic) __weak RVKKernel *target; // @synthesize target=_target;
- (void).cxx_destruct;
- (void)switchMode;
