...
@class NSArray, NSString, PBMapStringString, WEALTHMapStringTrafficSwitchItemPB, WEALTHPasswordTokenCreatorPB;
...
@property(readonly) _Bool hasSwitchInfo; // @dynamic hasSwitchInfo;
...
@property(retain, nonatomic) WEALTHMapStringTrafficSwitchItemPB *switchInfo; // @dynamic switchInfo;
