...
@interface giftprodGiftSceneNewTemplateInfoResult : NSObject
{
    _Bool _success;
    ...
    NSString *_fullPage;
    NSArray *_params;
    NSArray *_sceneHbTemplateList;
}

+ (Class)sceneHbTemplateListElementClass;
+ (Class)paramsElementClass;
@property(retain, nonatomic) NSArray *sceneHbTemplateList; // @synthesize sceneHbTemplateList=_sceneHbTemplateList;
