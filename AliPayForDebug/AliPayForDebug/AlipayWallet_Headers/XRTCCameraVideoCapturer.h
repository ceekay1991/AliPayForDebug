...
@interface XRTCCameraVideoCapturer : XRTCVideoCapturer <AVCaptureVideoDataOutputSampleBufferDelegate>
{
    ...
    long long _rotation;
    CriticalSection_e2a1dca8 _rslock;
    int _droppedFramesWithOutOfBuffer;
    _Bool _captureSessionUnderRestarting;
    _Bool _hasRetriedOnFatalError;
    _Bool _isRunning;
    _Bool _willBeRunning;
    _Bool _landscape;
    _Bool _imageMustBePortrait;
...
+ (id)captureDevices;
@property(nonatomic) _Bool imageMustBePortrait; // @synthesize imageMustBePortrait=_imageMustBePortrait;
...
- (id).cxx_construct;
- (void).cxx_destruct;
- (void)correntOrientation:(long long)arg1;
- (void)updateOrientation;
- (void)reconfigureCaptureSessionInput;
- (void)updateDeviceCaptureFormat:(id)arg1 fps:(long long)arg2;
- (void)restartCaptureSessionWhenOutOfBuffersHappen;
