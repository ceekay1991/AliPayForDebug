...
@interface kabaoprodTabGroupPassInfoReqPB : APDPBGeneratedMessage
{
}
...
@property(nonatomic) _Bool freshVisit; // @dynamic freshVisit;
...
@property(readonly) _Bool hasFreshVisit; // @dynamic hasFreshVisit;
@property(readonly) _Bool hasLatitude; // @dynamic hasLatitude;
@property(readonly) _Bool hasLongitude; // @dynamic hasLongitude;
@property(readonly) _Bool hasSupportTraffic; // @dynamic hasSupportTraffic;
...
@property(nonatomic) _Bool supportTraffic; // @dynamic supportTraffic;
