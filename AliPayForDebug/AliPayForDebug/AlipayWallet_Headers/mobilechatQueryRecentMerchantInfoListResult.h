...
@interface mobilechatQueryRecentMerchantInfoListResult : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSArray *recentMerchantInfoList; // @dynamic recentMerchantInfoList;
