...
@class AUToast, BEEOriginPhotoCheckbox, BEEPhotoCountLabel, NSArray, NSString, UIButton, UICollectionView;
...
@interface BEEGridPickController : DTViewController <BEEPhotoBrowserDelegate, BEEGridPickCellDelegate, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout>
{
    ...
    BEEOriginPhotoCheckbox *_originCheckbox;
}

@property(retain, nonatomic) BEEOriginPhotoCheckbox *originCheckbox; // @synthesize originCheckbox=_originCheckbox;
...
- (void)startImageEditorAppWithImage:(id)arg1 editType:(id)arg2 businessId:(id)arg3;
- (void)startEditAppForPhotoAtIndex:(unsigned long long)arg1 editType:(id)arg2 businessId:(id)arg3;
...
- (void)previewPhotoForOnlySelectionAtIndex:(unsigned long long)arg1;
