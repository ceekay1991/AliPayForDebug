...
@class NSString, PPChatAppBiz, PPChatContext, PPChatSettingsController, UIViewController;
...
@interface PPChatAppDelegate : NSObject <DTMicroApplicationDelegate>
{
    ...
    PPChatSettingsController *_settingsController;
}

+ (id)context;
@property(retain, nonatomic) PPChatSettingsController *settingsController; // @synthesize settingsController=_settingsController;
...
- (void).cxx_destruct;
- (void)reportRouteMiniProgram:(id)arg1 sourceId:(id)arg2 programId:(id)arg3;
- (void)reportForceLifeApp:(id)arg1;
- (void)cardHomeInvalidDataReport:(id)arg1;
- (void)dealloc;
...
- (_Bool)gotoProgramHomePage_New:(id)arg1;
- (_Bool)gotoProgramHomePage_Old:(id)arg1;
- (_Bool)gotoProgramHomePage:(id)arg1;
