...
@class APGLocalSearchEngineResult, APGSearchGroupResult, APGSearchManager, APGWKTableViewController, NSArray, NSString, UILabel, UIView;
...
@interface APGMessageLogDetailViewController : DTViewController <WKTableViewControllerDelegate>
{
    ...
    NSString *_tableName;
    NSString *_searchId;
    APGWKTableViewController *_tableViewController;
    UIView *_titleView;
...
@property(retain, nonatomic) APGWKTableViewController *tableViewController; // @synthesize tableViewController=_tableViewController;
