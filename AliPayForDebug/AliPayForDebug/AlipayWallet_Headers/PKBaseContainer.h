...
#import "PKCellDelegate-Protocol.h"
#import "PKTableViewDelegate-Protocol.h"
#import "UITableViewDataSource-Protocol.h"
#import "UITableViewDelegate-Protocol.h"

@class NSDictionary, NSMutableArray, NSMutableDictionary, NSString, PKCell, PKTableView, UIImageView;

@interface PKBaseContainer : MFBaseViewController <PKTableViewDelegate, UITableViewDataSource, UITableViewDelegate, PKCellDelegate>
{
...
- (void)removeTranslateContentWithSeed:(id)arg1;
...
- (id)handleSpecialBusinessUrl:(id)arg1 withInfo:(id)arg2;
...
- (double)adjustSafeAreaEdgeInsetsBotoom;
- (void)setupUI;
...
@property(readonly, nonatomic) NSMutableDictionary *indexPathDictionary;
