...
{
    _Bool _enableSearch;
    id <AUBladeViewDelegate> delegate;
    UIColor *highlightedBackgroundColor;
    UIColor *textColor;
    UIFont *_textFont;
    NSArray *_iconImageNames;
    NSArray *_iconTitles;
    NSArray *_defaultIndexes;
...
@property(retain, nonatomic) NSArray *defaultIndexes; // @synthesize defaultIndexes=_defaultIndexes;
...
@property(nonatomic) __weak id <AUBladeViewDelegate> delegate; // @synthesize delegate;
- (void).cxx_destruct;
