...
- (void).cxx_destruct;
- (_Bool)shouldCheckDBBeforeInsertMockMsg;
...
- (void)handleUpdatedMessages:(id)arg1 msgType:(id)arg2;
- (void)sendUpdatedMessages:(id)arg1 msgType:(id)arg2;
- (id)getRealSessionWithMessage:(id)arg1;
- (void)checkMockSystemMessage:(id)arg1;
- (id)handleMockJSONMessage:(id)arg1 forUpdate:(_Bool)arg2 msgOptType:(id)arg3;
- (void)sendMockMessagesWithMessage:(id)arg1;
...
- (void)handleBCContactInfoWithMessages:(id)arg1;
- (void)handleSessionMapWithMap:(id)arg1 cancelMap:(id)arg2 onlyUpdateMap:(id)arg3 deleteArray:(id)arg4 privateMsgSessionMap:(id)arg5 syncInfo:(id)arg6 clientMsgIds:(id)arg7 msgCount:(unsigned long long)arg8 logStartTime:(double)arg9 bizType:(id)arg10;
- (void)configItemTypeForMessage:(id)arg1;
