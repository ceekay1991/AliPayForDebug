...
@class CTDataFactoryViewController, NSString;

@interface HiChatAppDelegate : NSObject <DTMicroApplicationDelegate>
{
    CTDataFactoryViewController *_rootController;
}

@property(retain, nonatomic) CTDataFactoryViewController *rootController; // @synthesize rootController=_rootController;
- (void).cxx_destruct;
