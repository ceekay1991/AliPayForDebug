...
@class MBSwipeTableCell, NSArray, UIColor;

@interface MBSwipeButtonsView : UIView
{
    NSArray *_buttons;
    UIView *_container;
    _Bool _fromLeft;
...
@property(nonatomic) __weak MBSwipeTableCell *cell; // @synthesize cell=_cell;
- (void).cxx_destruct;
