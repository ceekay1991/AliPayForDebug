...
- (void)updateLeftItem;
- (void)checkEnvAndProcess:(id)arg1 jsApi:(id)arg2 handler:(CDUnknownBlockType)arg3 resposeCallback:(CDUnknownBlockType)arg4;
- (void)addJSApis;
- (id)currentViewController;
- (_Bool)isStandardColor:(id)arg1;
- (id)getShowImageWithIconType:(id)arg1 shouldSetDefaultColor:(_Bool)arg2;
- (void)setNavigationBar:(_Bool)arg1 rest:(_Bool)arg2;
