...
@interface CKNavigatorModule : NSObject <CKModuleProtocol>
{
    NSString *instanceId;
}

+ (id)mq_export_method_async_47;
+ (id)mq_export_method_async_46;
+ (id)mq_export_method_async_45;
+ (id)mq_export_method_async_44;
+ (id)mq_export_method_async_43;
+ (id)mq_export_method_async_42;
+ (id)mq_export_method_async_41;
+ (id)mq_export_method_async_40;
