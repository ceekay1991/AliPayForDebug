...
@interface LOTLayerContainer : CALayer
{
    ...
    id <LOTAssetsRetriver> _assetDelegate;
    struct CGRect _viewportBounds;
}

+ (_Bool)needsDisplayForKey:(id)arg1;
@property(nonatomic) __weak id <LOTAssetsRetriver> assetDelegate; // @synthesize assetDelegate=_assetDelegate;
...
- (id)initWithModel:(id)arg1 inLayerGroup:(id)arg2 assetDelegate:(id)arg3;
