...
#import "APGroupService-Protocol.h"
#import "ContactService-Protocol.h"
...
- (void).cxx_destruct;
- (void)stickyToTopWithUserType:(id)arg1 recentContact:(id)arg2 callback:(CDUnknownBlockType)arg3;
- (void)stickyToTopWithUserType:(id)arg1 sessionId:(id)arg2 callback:(CDUnknownBlockType)arg3;
