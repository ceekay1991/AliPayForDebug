...
@class ACCUtilityButtonView, NSArray, NSLayoutConstraint, NSString, UILongPressGestureRecognizer, UIPanGestureRecognizer, UIScrollView, UITableView, UITapGestureRecognizer, UIView;
@protocol ACCSwipeTableViewCellDelegate;

@interface ACCSwipeTableViewCell : UITableViewCell <UIScrollViewDelegate, UIGestureRecognizerDelegate>
{
    ...
    id <ACCSwipeTableViewCellDelegate> _delegate;
    ...
    ACCUtilityButtonView *_leftUtilityButtonsView;
    ACCUtilityButtonView *_rightUtilityButtonsView;
...
@property(retain, nonatomic) ACCUtilityButtonView *rightUtilityButtonsView; // @synthesize rightUtilityButtonsView=_rightUtilityButtonsView;
@property(retain, nonatomic) ACCUtilityButtonView *leftUtilityButtonsView; // @synthesize leftUtilityButtonsView=_leftUtilityButtonsView;
...
@property(nonatomic) __weak id <ACCSwipeTableViewCellDelegate> delegate; // @synthesize delegate=_delegate;
