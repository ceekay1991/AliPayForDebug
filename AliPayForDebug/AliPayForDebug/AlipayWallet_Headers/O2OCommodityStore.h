...
@class ALPViewController, NSDictionary;

@interface O2OCommodityStore : VZFluxStore
{
    _Bool _followChecked;
    NSDictionary *_buttonState;
    ALPViewController *_viewController;
}

@property(readonly, nonatomic) __weak ALPViewController *viewController; // @synthesize viewController=_viewController;
