...
@class APVideoPlayer, AVAudioPlayer, NSDictionary, NSString;
...
- (void)videoPlayer:(id)arg1 didEndSeek:(_Bool)arg2;
- (void)videoPlayerDidStartToSeek:(id)arg1;
...
@property(nonatomic) _Bool preloadData; // @dynamic preloadData;
...
- (void)resolveExtraParams:(id)arg1;
