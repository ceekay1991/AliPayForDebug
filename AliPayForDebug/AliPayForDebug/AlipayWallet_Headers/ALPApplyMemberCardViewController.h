...
@class ALPCreateMemberModel, ALPMemberCardListViewDataSource, ALPMemberCardListViewDelegate, ALPMemberCardPreviewModel, ALPQueryMemberInfoModel, AMCH5ServiceController, AUNetErrorView, KABAOPRODMemberCardRequest, NSString;
