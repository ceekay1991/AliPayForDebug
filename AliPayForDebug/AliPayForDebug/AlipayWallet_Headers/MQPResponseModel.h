...
@interface MQPResponseModel : NSObject
{
    ...
    NSArray *_tpls;
    NSDictionary *_msp_switch;
    NSNumber *_sysError;
    MQPNormalTrack *_track;
    NSNumber *_disableThirdCheck;
    NSNumber *_thirdPrompt;
}

@property(retain, nonatomic) NSNumber *thirdPrompt; // @synthesize thirdPrompt=_thirdPrompt;
@property(retain, nonatomic) NSNumber *disableThirdCheck; // @synthesize disableThirdCheck=_disableThirdCheck;
@property(retain, nonatomic) MQPNormalTrack *track; // @synthesize track=_track;
@property(retain, nonatomic) NSNumber *sysError; // @synthesize sysError=_sysError;
@property(retain, nonatomic) NSDictionary *msp_switch; // @synthesize msp_switch=_msp_switch;
...
@property(retain, nonatomic) NSString *syncEnd; // @synthesize syncEnd=_syncEnd;
...
@property(retain, nonatomic) NSDictionary *originalBody; // @synthesize originalBody=_originalBody;
