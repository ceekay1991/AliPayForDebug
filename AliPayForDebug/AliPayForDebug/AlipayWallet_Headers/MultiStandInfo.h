...
@class NSArray, NSString, StandInfo;

@interface MultiStandInfo : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) StandInfo *readedStandInfo; // @dynamic readedStandInfo;
