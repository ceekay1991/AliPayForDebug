...
+ (id)formatTimeValue:(long long)arg1;
+ (void)fileArrAtPath:(const char *)arg1 outArr:(id)arg2 withTimeInfo:(_Bool)arg3;
+ (id)sharedInstance;
...
- (void)uploadLogWithAccount:(id)arg1 startDate:(id)arg2 endDate:(id)arg3;
