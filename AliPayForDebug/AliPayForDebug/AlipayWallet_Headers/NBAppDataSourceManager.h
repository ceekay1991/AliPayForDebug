...
@class NAMApp, NAMAppDataSource, NBSession, NSMutableArray, NSMutableDictionary, NSMutableSet, NSString;
...
@interface NBAppDataSourceManager : NSObject <PSDPluginProtocol>
{
    ...
    NSMutableSet *_preloadResApps;
    NBSession *_currentSession;
}

@property(nonatomic) __weak NBSession *currentSession; // @synthesize currentSession=_currentSession;
@property(retain, nonatomic) NSMutableSet *preloadResApps; // @synthesize preloadResApps=_preloadResApps;
