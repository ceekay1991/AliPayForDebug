...
#import "PSDWebViewURLProtocolDelegate-Protocol.h"

@class NSDate, NSMutableData, NSString, NSURLRequest, NSURLResponse;
@protocol PSDURLProtocolProcessorDelegate;
...
- (void)PSDWebViewURLProtocol:(id)arg1 task:(id)arg2 didFinishCollectingMetrics:(id)arg3;
- (void)PSDWebViewURLProtocol:(id)arg1 didCancel:(id)arg2;
