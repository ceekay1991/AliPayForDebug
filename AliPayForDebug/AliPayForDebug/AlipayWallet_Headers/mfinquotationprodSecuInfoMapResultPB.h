...
@class NSString, mfinquotationprodMapStringSecuInfoPB;

@interface mfinquotationprodSecuInfoMapResultPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) mfinquotationprodMapStringSecuInfoPB *value; // @dynamic value;
