...
+ (id)sharedManager;
- (void).cxx_destruct;
- (void)reportClickForWidgetId:(id)arg1 isTopApps:(_Bool)arg2;
- (void)reportClickForWidgetId:(id)arg1;
- (void)doUpdateMoreBizMark:(CDUnknownBlockType)arg1 coldLaunch:(_Bool)arg2;
- (id)bizMarkAppList;
- (id)bizMarkModelForWidgetId:(id)arg1 isTopApps:(_Bool)arg2 topApps:(id)arg3;
- (id)bizMarkModelForWidgetId:(id)arg1 isTopApps:(_Bool)arg2;
