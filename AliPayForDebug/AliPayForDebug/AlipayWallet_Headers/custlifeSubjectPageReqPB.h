...
@interface custlifeSubjectPageReqPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasSubjectId; // @dynamic hasSubjectId;
...
@property(retain, nonatomic) NSString *subjectId; // @dynamic subjectId;
