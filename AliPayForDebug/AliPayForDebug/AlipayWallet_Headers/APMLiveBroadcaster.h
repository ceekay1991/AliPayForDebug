...
@class APMLiveConfig, APMVideoPreviewViewContainer, LiveBroadcasterFocusView, NSDate, NSLock, NSMutableArray, NSObject, NSString, NSTimer, UIImage, UITapGestureRecognizer, VCSimpleSession;
@protocol APMLiveBroadcasterDelegate, OS_dispatch_queue, OS_dispatch_semaphore;
