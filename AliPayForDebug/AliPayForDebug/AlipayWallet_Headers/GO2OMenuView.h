...
#import "GO2OMenuPopoverViewDelegate-Protocol.h"
#import "GO2OMenuTopViewDelegate-Protocol.h"

@class GO2OMenuPopoverView, GO2OMenuTopView, NSArray, NSString;
@protocol GO2OMenuViewDelegate;
...
- (void)menuTopViewDidToggleRadioButtonAtIndex:(unsigned long long)arg1;
- (void)didSelectedAtIndex:(unsigned long long)arg1 show:(_Bool)arg2;
- (void)disappearPopover;
- (void)reloadTopView;
- (void)reloadData:(id)arg1;
- (id)initWithFrame:(struct CGRect)arg1 spmPrefix:(id)arg2;
