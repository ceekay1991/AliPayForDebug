...
@class NSString, publictestFeedBackScoreVoPB;

@interface publictestFeedBackResultPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) publictestFeedBackScoreVoPB *pb_data; // @dynamic pb_data;
