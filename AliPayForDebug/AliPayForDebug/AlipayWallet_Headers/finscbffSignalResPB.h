...
@class NSString, finscbffSignalInfoPB;

@interface finscbffSignalResPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasSignal; // @dynamic hasSignal;
...
@property(retain, nonatomic) finscbffSignalInfoPB *signal; // @dynamic signal;
