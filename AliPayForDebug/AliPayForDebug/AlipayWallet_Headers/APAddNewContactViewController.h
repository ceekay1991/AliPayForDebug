...
#import "APContactTableViewCellDelegate-Protocol.h"
...
@class APContactResponseVO, APSearchBar, APSearchDisplayController, APSearchManager, AUButton, AUTableView, AUTextField, DTRpcAsyncCaller, NSArray, NSMutableArray, NSOperationQueue, NSString, SocialRecommendService, UILabel, UIView;
...
@interface APAddNewContactViewController : DTViewController <APContactViewControllerDelegate, APSearchDisplayControllerDelegate, APContactTableViewCellDelegate, UIActionSheetDelegate, UITextFieldDelegate, UITableViewDelegate, UITableViewDataSource>
{
    ...
    UIView *_recommendCard;
    NSOperationQueue *_searchIndexQueue;
}

@property(retain, nonatomic) NSOperationQueue *searchIndexQueue; // @synthesize searchIndexQueue=_searchIndexQueue;
@property(retain, nonatomic) UIView *recommendCard; // @synthesize recommendCard=_recommendCard;
...
@property(retain, nonatomic) AUButton *nextBt; // @synthesize nextBt=_nextBt;
...
- (void).cxx_destruct;
- (_Bool)jumpSecretActions:(id)arg1;
