...
@interface mfinquotationprodIndicatorResultPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSArray *dataArr; // @dynamic dataArr;
...
@property(retain, nonatomic) NSArray *timeArr; // @dynamic timeArr;
