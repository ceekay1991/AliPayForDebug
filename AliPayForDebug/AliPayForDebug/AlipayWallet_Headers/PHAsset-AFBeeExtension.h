...
#import "AFBEEAssetProtocol-Protocol.h"

@class NSString;

@interface PHAsset (AFBeeExtension) <AFBEEAssetProtocol>
+ (_Bool)bee_isInBackgroundActivity;
...
- (void)bee_updateAssetPropertyWithInfo:(id)arg1;
