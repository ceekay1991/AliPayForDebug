...
@interface GO2OShopInfo : GO2OServiceObject
{
    ...
    NSString *_reportErrorUrl;
}

@property(retain, nonatomic) NSString *reportErrorUrl; // @synthesize reportErrorUrl=_reportErrorUrl;
@property(retain, nonatomic) NSString *shopCodeUrl; // @synthesize shopCodeUrl=_shopCodeUrl;
