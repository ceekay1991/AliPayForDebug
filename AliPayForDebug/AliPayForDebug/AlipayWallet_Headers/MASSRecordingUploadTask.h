...
@class ConnectTimer, DataResponseTimer, FlowStatisticInfo, NSMutableData, NSString;
...
@property(nonatomic) long long receiveFromBizTime; // @synthesize receiveFromBizTime=_receiveFromBizTime;
