...
@class DTRpcMethod, NSArray, NSCachedURLResponse, NSDictionary, NSMutableDictionary, NSString, NSURLConnection, NSURLProtocol, NSURLRequest, NSURLSessionDataTask;
...
@property(retain, nonatomic) NSDictionary *rpcExtensions; // @synthesize rpcExtensions=_rpcExtensions;
@property(nonatomic) _Bool isTsErrRetry; // @synthesize isTsErrRetry=_isTsErrRetry;
@property(nonatomic) _Bool useMultiLink; // @synthesize useMultiLink=_useMultiLink;
