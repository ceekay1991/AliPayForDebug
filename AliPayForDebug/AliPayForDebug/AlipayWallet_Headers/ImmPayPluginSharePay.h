...
@class MQPSharePayChannelView, NSDictionary, NSString;
...
@property(copy, nonatomic) NSString *pageSpmId; // @synthesize pageSpmId=_pageSpmId;
@property(retain, nonatomic) NSDictionary *param4; // @synthesize param4=_param4;
- (void).cxx_destruct;
- (void)dealloc;
