...
@class BEEAssetData, NSArray, NSError;
@protocol BEEAssetProtocol;

@protocol BEEPhotoPickerDelegate <NSObject>

@optional
- (void)photoPickerController:(id)arg1 endCompressWithVideo:(BEEAssetData *)arg2 orError:(NSError *)arg3;
- (_Bool)photoPickerController:(id)arg1 startCompressVideo:(id <BEEAssetProtocol>)arg2 orData:(BEEAssetData *)arg3;
