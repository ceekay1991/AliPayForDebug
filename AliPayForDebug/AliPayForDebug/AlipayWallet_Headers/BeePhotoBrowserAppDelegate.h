...
@class BEEPhotoBrowserHelper, NSString, UIViewController;

@interface BeePhotoBrowserAppDelegate : NSObject <DTMicroApplicationDelegate>
{
    UIViewController *_rootController;
    BEEPhotoBrowserHelper *_photoHelper;
}

@property(retain, nonatomic) BEEPhotoBrowserHelper *photoHelper; // @synthesize photoHelper=_photoHelper;
@property(retain, nonatomic) UIViewController *rootController; // @synthesize rootController=_rootController;
- (void).cxx_destruct;
- (void)parsePhotoPreviewOptions:(id)arg1;
