...
@interface minicenterMiniAppAuthInfoQueryResultPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasAccessToken; // @dynamic hasAccessToken;
@property(readonly) _Bool hasAuthorized; // @dynamic hasAuthorized;
