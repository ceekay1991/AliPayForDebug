...
#import "DirectConnectionDelegate-Protocol.h"
#import "InteractiveConnectionDelegate-Protocol.h"

@class NSData, NSString, WDBleDevice;
@protocol WDAuthenticatorDelegate, WDPeripheralDelegate, WDProcessDelegate;
