...
@class APSKClient, NSArray, NSMutableArray, NSString, ODRefreshControl, PPChatHeaderView, PPChatMessage, PPChatMessageLoadingViewForRecord, PPChatNewsItem, PPChatPublicAccount, PPChatThirdPartyAccount, UIActivityIndicatorView, UIColor, UIGestureRecognizer, UITableView, UIView;
@protocol PPChatMessageDataSource;
