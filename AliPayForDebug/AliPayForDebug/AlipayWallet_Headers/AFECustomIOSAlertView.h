...
#import "AFECustomIOSAlertViewDelegate-Protocol.h"

@class NSArray;
@protocol AFECustomIOSAlertViewDelegate;

@interface AFECustomIOSAlertView : UIView <AFECustomIOSAlertViewDelegate>
{
    double buttonHeight;
    ...
    id <AFECustomIOSAlertViewDelegate> delegate;
    NSArray *buttonTitles;
}

+ (id)alertViewWithTitle:(id)arg1 detail:(id)arg2;
...
@property(nonatomic) __weak id <AFECustomIOSAlertViewDelegate> delegate; // @synthesize delegate;
