...
- (void)initializeWithChildGroup:(id)arg1 withAssetGroup:(id)arg2 withAssetDelegate:(id)arg3;
- (id)initWithModel:(id)arg1 inLayerGroup:(id)arg2 withLayerGroup:(id)arg3 withAssestGroup:(id)arg4 withAssetDelegate:(id)arg5;
