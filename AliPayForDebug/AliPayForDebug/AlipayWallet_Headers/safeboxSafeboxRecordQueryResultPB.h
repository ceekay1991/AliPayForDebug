...
@interface safeboxSafeboxRecordQueryResultPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) NSString *encryptSafeboxRecordJson; // @dynamic encryptSafeboxRecordJson;
@property(readonly) _Bool hasEncryptSafeboxRecordJson; // @dynamic hasEncryptSafeboxRecordJson;
