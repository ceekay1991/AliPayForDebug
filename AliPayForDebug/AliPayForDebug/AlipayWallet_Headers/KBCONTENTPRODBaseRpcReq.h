...
@interface KBCONTENTPRODBaseRpcReq : KBCONTENTPRODToString
{
    DTDouble *_longitude;
    DTDouble *_latitude;
    NSString *_cityCode;
    ...
    NSString *_clientChannel;
}

@property(retain, nonatomic) NSString *clientChannel; // @synthesize clientChannel=_clientChannel;
