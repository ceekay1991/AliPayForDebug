...
@class AlipayLifeListModel, NSDictionary, NSString, UILabel;
@protocol AlipayLifeListManagerDelegate;

@interface AlipayLifeListVC : AlipayLifeCBBaseVC <CRouterCenterOpenHandler, AlipayLifeListManagerCallbackDelegate>
{
...
- (void)reloadList:(id)arg1 loadType:(long long)arg2 sync:(_Bool)arg3;
...
- (id)headerView:(id)arg1 subTitle:(id)arg2;
