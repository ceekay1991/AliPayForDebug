...
@interface APShareExtInfo : NSObject
{
    ...
    NSMutableDictionary *_customSelectContactParams;
}

@property(retain, nonatomic) NSMutableDictionary *customSelectContactParams; // @synthesize customSelectContactParams=_customSelectContactParams;
