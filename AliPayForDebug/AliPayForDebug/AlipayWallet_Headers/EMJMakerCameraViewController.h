...
@class EMJCameraMaskView, EMJEditorView, NSArray, NSLayoutConstraint, NSString, TGCamera, UIActivityIndicatorView, UIButton, UICollectionView, UIView;
@protocol EMJMakerCameraViewControllerDelegate;

@interface EMJMakerCameraViewController : DTBaseViewController <UINavigationControllerDelegate, UIImagePickerControllerDelegate, UICollectionViewDelegate, UICollectionViewDataSource, AUDialogDelegate>
{
...
- (struct UIEdgeInsets)EMJSafeAreaInsets;
