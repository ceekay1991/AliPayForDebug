...
{
    CDStruct_3f8c4f5d _myFlags;
    _Bool _beInStartMode;
}

+ (id)allocPrivate;
+ (id)sharedInstance;
@property(nonatomic) _Bool beInStartMode; // @synthesize beInStartMode=_beInStartMode;
- (_Bool)isStartMode;
- (id)components;
...
- (void)dealloc;
- (id)initPrivate;
- (id)swizzle_createSceneWithSceneParam:(id)arg1 parentObject:(id)arg2;
- (void)addExtensionInterceptor;
- (void)configAll;
