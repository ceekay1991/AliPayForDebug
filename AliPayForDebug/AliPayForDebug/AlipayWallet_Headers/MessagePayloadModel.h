...
@interface MessagePayloadModel : APPBGeneratedMessage <GeneratedMessageProtocol>
{
    ...
    _Bool _hasContext;
    _Bool _hasIgnoreApp;
    _Bool _hasMsgOptType;
    _Bool _hasSessionVersion;
    _Bool _hasItemVersion;
    _Bool _hasFromType;
    _Bool _hasCenter;
    _Bool _hasCenterV2;
    _Bool _hasMonitorParams;
    _Bool _hasRedPointStyle;
    int _action;
    NSString *_fromUId;
    ...
    NSMutableArray *_sessionInfo;
    NSMutableArray *_sessionConfigs;
    long long _sessionVersion;
    NSMutableArray *_itemInfo;
    NSMutableArray *_itemConfigs;
...
@property(retain, nonatomic) NSString *centerV2; // @synthesize centerV2=_centerV2;
...
@property(retain, nonatomic) NSMutableArray *itemConfigs; // @synthesize itemConfigs=_itemConfigs;
@property(retain, nonatomic) NSMutableArray *itemInfo; // @synthesize itemInfo=_itemInfo;
@property(nonatomic) long long sessionVersion; // @synthesize sessionVersion=_sessionVersion;
@property(retain, nonatomic) NSMutableArray *sessionConfigs; // @synthesize sessionConfigs=_sessionConfigs;
@property(retain, nonatomic) NSMutableArray *sessionInfo; // @synthesize sessionInfo=_sessionInfo;
...
@property(readonly) _Bool hasRedPointStyle; // @synthesize hasRedPointStyle=_hasRedPointStyle;
@property(readonly) _Bool hasMonitorParams; // @synthesize hasMonitorParams=_hasMonitorParams;
@property(readonly) _Bool hasCenterV2; // @synthesize hasCenterV2=_hasCenterV2;
@property(readonly) _Bool hasCenter; // @synthesize hasCenter=_hasCenter;
@property(readonly) _Bool hasFromType; // @synthesize hasFromType=_hasFromType;
@property(readonly) _Bool hasItemVersion; // @synthesize hasItemVersion=_hasItemVersion;
@property(readonly) _Bool hasSessionVersion; // @synthesize hasSessionVersion=_hasSessionVersion;
@property(readonly) _Bool hasMsgOptType; // @synthesize hasMsgOptType=_hasMsgOptType;
...
- (void)addItemConfigs:(id)arg1;
- (void)setItemConfigsArray:(id)arg1;
- (void)addItemInfo:(id)arg1;
- (void)setItemInfoArray:(id)arg1;
- (void)addSessionConfigs:(id)arg1;
- (void)setSessionConfigsArray:(id)arg1;
- (void)addSessionInfo:(id)arg1;
- (void)setSessionInfoArray:(id)arg1;
- (int)serializedSize;
