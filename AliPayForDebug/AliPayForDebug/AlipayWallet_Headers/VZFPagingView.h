...
@class NSArray, NSSet, NSString, NSTimer, UIPageControl, UIScrollView, VZFAppearListenerManager;

@interface VZFPagingView : UIView <VZFNodeBackingViewInterface, UIScrollViewDelegate, VZFAppearProtocol>
{
    NSArray *_childViews;
    NSTimer *_timer;
    _Bool _isActive;
