...
@property(nonatomic) _Bool firstEntered; // @synthesize firstEntered=_firstEntered;
...
@property(readonly) _Bool hasFirstEntered; // @synthesize hasFirstEntered=_hasFirstEntered;
