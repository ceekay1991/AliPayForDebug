...
@class EmotionShowView, UIImage, UIImageView, UILabel;
...
@interface EmotionPreviewView : UIView
{
    ...
    UIImage *_bigEmotionPreviewImage;
    UIImage *_bigEmotionPreviewCentreImage;
}

@property(retain, nonatomic) UIImage *bigEmotionPreviewCentreImage; // @synthesize bigEmotionPreviewCentreImage=_bigEmotionPreviewCentreImage;
@property(retain, nonatomic) UIImage *bigEmotionPreviewImage; // @synthesize bigEmotionPreviewImage=_bigEmotionPreviewImage;
...
- (void).cxx_destruct;
- (void)setBigEmotionPreviewImage:(id)arg1 bigEmotionPreviewCentreImage:(id)arg2;
