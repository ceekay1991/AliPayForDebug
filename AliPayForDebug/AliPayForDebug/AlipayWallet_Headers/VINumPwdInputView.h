...
@protocol VINumPwdInputViewDelegate;

@interface VINumPwdInputView : UIView <UITextFieldDelegate>
{
    UILabel *_labels[6];
    _Bool _numericPassword;
    UITextField *_textField;
    id <VINumPwdInputViewDelegate> _delegate;
    UILabel *_titleLabel;
    double _scaleFactor;
...
@property(nonatomic) __weak id <VINumPwdInputViewDelegate> delegate; // @synthesize delegate=_delegate;
