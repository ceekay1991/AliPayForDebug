...
#import "PKTranslateContentDelegate-Protocol.h"

@class NSDictionary, NSMutableDictionary, NSString, PKImageView, PKShareSourceView, PKTipsWidget, PKTranslateContentView;

@interface PKBaseCell : UITableViewCell <PKTranslateContentDelegate>
{
    _Bool _canDelete;
    _Bool _hasHeaderView;
    _Bool _hasShareSourceView;
    _Bool _hasFooterView;
    _Bool _hasTranslateContentView;
...
@property(retain, nonatomic) PKTranslateContentView *translateContentView; // @synthesize translateContentView=_translateContentView;
...
@property(nonatomic) struct CGSize sectionTranslateContentSize; // @synthesize sectionTranslateContentSize=_sectionTranslateContentSize;
...
@property(nonatomic) _Bool hasTranslateContentView; // @synthesize hasTranslateContentView=_hasTranslateContentView;
...
- (void).cxx_destruct;
- (void)handleTranslateLongPress:(id)arg1;
- (void)handleTranslateTap:(id)arg1;
...
- (void)layoutTranslateContentView;
...
- (void)setupTranslateContentView;
