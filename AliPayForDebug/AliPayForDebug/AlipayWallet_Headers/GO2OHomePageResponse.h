...
@class APSHOPCENTERCity, GO2OAreaInfo, GO2OBottomPopup, GO2OPopupInfo, NSArray, NSDictionary, NSString, O2OLocationCityInfo;
...
@interface GO2OHomePageResponse : GO2OServiceObject
{
    ...
    GO2OPopupInfo *_popup;
    GO2OBottomPopup *_bottomPopup;
...
@property(retain, nonatomic) GO2OBottomPopup *bottomPopup; // @synthesize bottomPopup=_bottomPopup;
@property(retain, nonatomic) GO2OPopupInfo *popup; // @synthesize popup=_popup;
