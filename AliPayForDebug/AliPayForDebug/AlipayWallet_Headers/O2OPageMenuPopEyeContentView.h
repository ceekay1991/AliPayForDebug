...
@interface O2OPageMenuPopEyeContentView : O2OPageMenuContentBaseView
{
    double rgbNormal[4];
    ...
    UIImageView *_itemSelectedImage;
}

@property(retain, nonatomic) UIImageView *itemSelectedImage; // @synthesize itemSelectedImage=_itemSelectedImage;
