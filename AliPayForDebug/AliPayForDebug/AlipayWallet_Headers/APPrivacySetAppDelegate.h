...
@interface APPrivacySetAppDelegate : NSObject <DTMicroApplicationDelegate>
{
...
- (void).cxx_destruct;
- (void)fetchContactInfoAndOpenPageWithApplication:(id)arg1 userId:(id)arg2 loginId:(id)arg3;
