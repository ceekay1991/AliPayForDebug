...
@interface O2OSearchModelCommonParams : NSObject <NSCopying>
{
    ...
    NSString *_tokenId;
    NSString *_locationAccuracy;
    long long _activityFilterType;
    NSString *_sessionId;
    NSString *_queryIndex;
}

@property(copy, nonatomic) NSString *queryIndex; // @synthesize queryIndex=_queryIndex;
@property(copy, nonatomic) NSString *sessionId; // @synthesize sessionId=_sessionId;
@property(nonatomic) long long activityFilterType; // @synthesize activityFilterType=_activityFilterType;
@property(copy, nonatomic) NSString *locationAccuracy; // @synthesize locationAccuracy=_locationAccuracy;
...
@property(copy, nonatomic) NSString *actionSrc; // @synthesize actionSrc=_actionSrc;
