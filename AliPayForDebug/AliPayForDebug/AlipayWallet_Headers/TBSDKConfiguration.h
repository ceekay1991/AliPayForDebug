...
@protocol MtopReportDataSetProtocol;
...
@interface TBSDKConfiguration : NSObject <TBSDKConfigurationPrivate>
{
    ...
    id <MtopReportDataSetProtocol> _reportDataSetDelegate;
...
@property(nonatomic) __weak id <MtopReportDataSetProtocol> reportDataSetDelegate; // @synthesize reportDataSetDelegate=_reportDataSetDelegate;
...
@property(copy) NSString *wapTTID; // @synthesize wapTTID=_wapTTID;
