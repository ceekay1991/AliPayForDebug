...
@class NSString, finscbffLiveInfoDataPB;

@interface finscbffLiveInfoResultPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasLiveInfo; // @dynamic hasLiveInfo;
...
@property(retain, nonatomic) finscbffLiveInfoDataPB *liveInfo; // @dynamic liveInfo;
