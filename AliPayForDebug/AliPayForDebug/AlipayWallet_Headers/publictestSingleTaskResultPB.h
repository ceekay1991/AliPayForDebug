...
@class NSString, publictestTaskVoPB;

@interface publictestSingleTaskResultPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasTaskVo; // @dynamic hasTaskVo;
...
@property(retain, nonatomic) publictestTaskVoPB *taskVo; // @dynamic taskVo;
