...
@class FHAssetsEditViewController, NSString;

@interface FHAssetsEditAppDelegate : NSObject <DTMicroApplicationDelegate>
{
    FHAssetsEditViewController *_rootController;
}

@property(retain, nonatomic) FHAssetsEditViewController *rootController; // @synthesize rootController=_rootController;
- (void).cxx_destruct;
