...
@interface BEERegionRootViewController : DTViewController <UITableViewDataSource, UITableViewDelegate>
{
    ...
    NSString *_maxLevel;
    NSMutableArray *_customRegionDatas;
...
@property(nonatomic) _Bool isEnlanguge; // @synthesize isEnlanguge=_isEnlanguge;
...
@property(retain, nonatomic) NSMutableArray *customRegionDatas; // @synthesize customRegionDatas=_customRegionDatas;
