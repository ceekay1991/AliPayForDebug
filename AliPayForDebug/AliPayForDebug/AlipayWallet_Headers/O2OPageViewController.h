...
@class NSArray, NSMutableArray, NSString, O2OPageMenuConfigure, O2OPageMenuDropdownButton, O2OPageMenuView, O2OPageScrollView, O2OPageViewDropdownView;
...
@property(retain, nonatomic) O2OPageScrollView *scrollView; // @synthesize scrollView=_scrollView;
...
@property(readonly, nonatomic) __weak UIView *currentContentView;
