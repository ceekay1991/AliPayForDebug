...
@interface AMapNetworkOperation : NSOperation <NSURLConnectionDelegate>
{
    ...
    CDUnknownBlockType _alipayCompletionHandler;
...
@property(copy, nonatomic) CDUnknownBlockType alipayCompletionHandler; // @synthesize alipayCompletionHandler=_alipayCompletionHandler;
...
- (void)setAlipayCompletionHandlerBlock:(CDUnknownBlockType)arg1;
