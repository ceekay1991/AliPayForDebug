...
- (void).cxx_destruct;
- (id)fetchSidInvaildTime:(id)arg1;
- (id)fetchLoginToken:(id)arg1;
- (id)fetchLoginTime:(id)arg1;
- (id)fetchSSOToken:(id)arg1;
- (id)fetchCookies:(id)arg1;
- (id)fetchUserId:(id)arg1;
- (id)fetchEcode:(id)arg1;
- (id)fetchNick:(id)arg1;
- (id)fetchSid:(id)arg1;
- (id)getCurrentAccountInfo:(id)arg1 forKey:(id)arg2;
