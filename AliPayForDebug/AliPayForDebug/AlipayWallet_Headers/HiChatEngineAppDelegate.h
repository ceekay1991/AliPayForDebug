...
@class HiChatEngineContainer, NSString;

@interface HiChatEngineAppDelegate : NSObject <DTMicroApplicationDelegate>
{
    HiChatEngineContainer *_rootController;
}

@property(retain, nonatomic) HiChatEngineContainer *rootController; // @synthesize rootController=_rootController;
- (void).cxx_destruct;
