...
@class NSArray, NSString, O2OMerchantAnchorItem, O2OMerchantAnchorView, O2OMerchantTabItem, O2OMerchantViewDataSource;
...
@interface O2OMerchantListViewDelegate : VZListViewDelegate <BEEPhotoBrowserDelegate, UITableViewDelegate>
{
    ...
    O2OMerchantAnchorItem *_headerItem;
    O2OMerchantTabItem *_tabItem;
    O2OMerchantAnchorView *_anchorHeader;
}

@property(retain, nonatomic) O2OMerchantAnchorView *anchorHeader; // @synthesize anchorHeader=_anchorHeader;
@property(retain, nonatomic) O2OMerchantTabItem *tabItem; // @synthesize tabItem=_tabItem;
@property(retain, nonatomic) O2OMerchantAnchorItem *headerItem; // @synthesize headerItem=_headerItem;
