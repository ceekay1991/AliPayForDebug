...
@interface APMAudioSession : NSObject
{
    CriticalSection_b058bf81 _crit;
...
- (_Bool)unconfigureAudioSession:(id *)arg1;
- (_Bool)configureAudioSessionWith:(id)arg1 error:(id *)arg2;
...
@property(readonly, nonatomic) vector_22992324 delegates; // @synthesize delegates=_delegates;
