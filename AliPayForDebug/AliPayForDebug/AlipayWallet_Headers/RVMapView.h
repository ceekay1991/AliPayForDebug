...
@class NSString;
@protocol RVMapViewDataSource, RVMapViewDelegate, RVMapViewProtocol;

@interface RVMapView : UIView <RVMapViewProtocol>
{
    UIView<RVMapViewProtocol> *_mapView;
    long long _mapType;
}

@property(nonatomic) long long mapType; // @synthesize mapType=_mapType;
@property(retain, nonatomic) UIView<RVMapViewProtocol> *mapView; // @synthesize mapView=_mapView;
- (void).cxx_destruct;
