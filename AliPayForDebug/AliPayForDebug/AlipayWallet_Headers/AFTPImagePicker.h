...
#import "AFBEEPhotoPickerDelegate-Protocol.h"
#import "UIImagePickerControllerDelegate-Protocol.h"

@class NSMutableDictionary, NSString, UIViewController;

@interface AFTPImagePicker : NSObject <AFBEEPhotoPickerDelegate, UIImagePickerControllerDelegate>
{
...
- (void)pickImage:(id)arg1 viewController:(id)arg2 view:(id)arg3 completeBlock:(CDUnknownBlockType)arg4;
