...
@class NSString, finscbffTendencyAdvancedDataPB;

@interface finscbffTendencyAdvancedResultPB : APDPBGeneratedMessage
{
}
...
@property(retain, nonatomic) finscbffTendencyAdvancedDataPB *pb_data; // @dynamic pb_data;
