...
@interface NPFileDownloadTask : NSObject
{
    _Bool _canceled;
    NSNumber *_taskId;
    NSString *_tfsDownloadTaskId;
...
@property(copy, nonatomic) NSString *tfsDownloadTaskId; // @synthesize tfsDownloadTaskId=_tfsDownloadTaskId;
