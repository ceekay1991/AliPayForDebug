...
@class AUCustomDatePicker, AliTallyAccountSelectView, AliTallyCategorySelectView, AliTallyKeyboardV2View, AliTallyPhotoAlbumView, AliTallyStatusBar, CreateNoteModel, NSArray, NSMutableArray, NSString, TallyDropDownList, UIButton, UIImageView, UILabel, UIView;
@protocol WealthTallyEditNoteV2ViewControllerDelegate;

@interface WealthTallyEditNoteV2ViewController : WealthTallyBaseViewController <AUDialogDelegate, UIActionSheetDelegate, UITextFieldDelegate, AliTallyCategorySelectViewDelegate, AliTallyKeyboardV2ViewDelegate, AliTallyKeyboardV2ViewDataSource, TallyDropDownListDelegate, AliTallyAccountSelectViewDelegate, BEEPhotoPickerDelegate, BEEPhotoBrowserDelegate>
{
...
- (void).cxx_destruct;
- (id)x_createTallyLabelButton:(long long)arg1;
