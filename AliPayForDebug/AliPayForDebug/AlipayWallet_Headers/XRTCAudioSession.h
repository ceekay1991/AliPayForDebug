...
#import "XRTCAudioSessionActivationDelegate-Protocol.h"

@class AVAudioSession, AVAudioSessionDataSourceDescription, AVAudioSessionRouteDescription, NSArray, NSString;

@interface XRTCAudioSession : NSObject <XRTCAudioSessionActivationDelegate>
{
    CriticalSection_e2a1dca8 _crit;
...
@property(readonly, nonatomic) vector_79838ee4 delegates; // @synthesize delegates=_delegates;
