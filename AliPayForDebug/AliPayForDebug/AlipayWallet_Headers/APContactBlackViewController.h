...
@class DTRpcAsyncCaller, NSArray, SocialCommonErrorView;

@interface APContactBlackViewController : APContactBaseViewController
{
    DTRpcAsyncCaller *_rpcCaller;
    DTRpcAsyncCaller *_rpcCaller_getList;
    NSArray *_rpcResultContacts;
}

@property(retain, nonatomic) NSArray *rpcResultContacts; // @synthesize rpcResultContacts=_rpcResultContacts;
...
- (void).cxx_destruct;
- (void)rpcGetBlackList;
- (void)rpcAddToBlackList:(_Bool)arg1 contact:(id)arg2;
