...
- (void)photoBrowser:(BEEPhotoBrowser *)arg1 videoCancelPlayAtIndex:(unsigned long long)arg2;
- (void)photoBrowser:(BEEPhotoBrowser *)arg1 videoFinishPlayAtIndex:(unsigned long long)arg2;
- (void)photoBrowser:(BEEPhotoBrowser *)arg1 videoStopPlayAtIndex:(unsigned long long)arg2;
- (void)photoBrowser:(BEEPhotoBrowser *)arg1 videoPausePlayAtIndex:(unsigned long long)arg2;
- (void)photoBrowser:(BEEPhotoBrowser *)arg1 videoStartPlayAtIndex:(unsigned long long)arg2;
- (_Bool)canVideoAutoReplay:(BEEPhotoBrowser *)arg1 atIndex:(unsigned long long)arg2;
...
- (void)photoBrowser:(BEEPhotoBrowser *)arg1 startEditPhoto:(BEEPhoto *)arg2 atIndex:(unsigned long long)arg3;
- (_Bool)photoBrowser:(BEEPhotoBrowser *)arg1 enablePhotoEdit:(BEEPhoto *)arg2 atIndex:(unsigned long long)arg3;
...
- (void)photoBrowser:(BEEPhotoBrowser *)arg1 savePhotoAtIndex:(long long)arg2 isSuccess:(_Bool)arg3;
