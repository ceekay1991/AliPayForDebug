...
@interface finscbffMarketCapitalTrendReqPB : APDPBGeneratedMessage
{
}
...
@property(readonly) _Bool hasTradeType; // @dynamic hasTradeType;
...
@property(retain, nonatomic) NSString *tradeType; // @dynamic tradeType;
