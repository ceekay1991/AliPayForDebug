...
@class NSDictionary, NSString, kbscprodAddressFilterInfo;

@interface kbscprodAddressFilterBlock : NSObject
{
    int _displaySort;
    ...
    NSString *_blockId;
    NSString *_blockName;
    kbscprodAddressFilterInfo *_addressFilterInfo;
}

+ (Class)expandInfoElementClass;
@property(nonatomic) int displaySort; // @synthesize displaySort=_displaySort;
@property(retain, nonatomic) kbscprodAddressFilterInfo *addressFilterInfo; // @synthesize addressFilterInfo=_addressFilterInfo;
