...
@class NSDictionary, NSString, RVAAppConfigManager, RVKSession, RVRDataSourceManager, UIViewController;
...
@interface RVASessionContext : NSObject
{
    ...
    RVRDataSourceManager *_appDataSourceManager;
    RVAAppConfigManager *_appConfigManager;
    NSDictionary *_expando;
}

@property(retain, nonatomic) NSDictionary *expando; // @synthesize expando=_expando;
@property(retain, nonatomic) RVAAppConfigManager *appConfigManager; // @synthesize appConfigManager=_appConfigManager;
@property(retain, nonatomic) RVRDataSourceManager *appDataSourceManager; // @synthesize appDataSourceManager=_appDataSourceManager;
