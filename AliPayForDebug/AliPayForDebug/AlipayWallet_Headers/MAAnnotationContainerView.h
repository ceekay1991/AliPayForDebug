...
#import "MAAnimatedAnnotationDelegate-Protocol.h"
...
@interface MAAnnotationContainerView : UIView <MAAnnotationViewDelegate, MAAnimatedAnnotationDelegate>
{
...
- (void)didAnnotationAnimationComplete:(id)arg1;
- (void)willAnnotationAnimationStart:(id)arg1;
- (void)MAAnnotationContainerViewDeallocOperation;
- (void)dealloc;
- (id)initWithFrame:(struct CGRect)arg1;
- (id)viewForAnnotation:(id)arg1;
- (void)sortAnnotationViews:(id)arg1;
